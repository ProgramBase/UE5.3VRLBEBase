...
public:
	...
	static bool PXR_GetAnchorEntityUuid(AActor* BoundActor, FPICOSpatialUUID& OutAnchorUUID);
	...
	/// </returns>
	UFUNCTION(BlueprintPure, Category = "PXR|PXRMR")
	static bool PXR_GetAnchorPoseByComponent(UPICOAnchorComponent* AnchorComponent, FTransform& OutTransform);
	...
	/// </returns>
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRMR")
	static bool PXR_DestroyAnchorByComponent(UPICOAnchorComponent* AnchorComponent);
	...
	/// </returns>
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRMR")
	static bool PXR_DestroyAnchorByActor(AActor* BoundActor);

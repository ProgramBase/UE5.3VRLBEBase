...
{
	[PathName("/Script/ObjectMixerEditor.ObjectMixerOutlinerModeConfig")]
	public partial class FObjectMixerOutlinerModeConfig : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ObjectMixerEditor.ObjectMixerOutlinerModeConfig");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FObjectMixerOutlinerModeConfig() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FObjectMixerOutlinerModeConfig() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FObjectMixerOutlinerModeConfig A, FObjectMixerOutlinerModeConfig B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FObjectMixerOutlinerModeConfig A, FObjectMixerOutlinerModeConfig B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FObjectMixerOutlinerModeConfig;

...
{
	[PathName("/Script/MetasoundFrontend.MetasoundFrontendClassMetadata")]
	public partial class FMetasoundFrontendClassMetadata : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/MetasoundFrontend.MetasoundFrontendClassMetadata");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FMetasoundFrontendClassMetadata() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FMetasoundFrontendClassMetadata() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FMetasoundFrontendClassMetadata A, FMetasoundFrontendClassMetadata B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FMetasoundFrontendClassMetadata A, FMetasoundFrontendClassMetadata B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FMetasoundFrontendClassMetadata;
		...
		public FText PromptIfMissingTransient
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __PromptIfMissingTransient, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __PromptIfMissingTransient, __InBuffer);
				}
			}
		}
		...
		public FString Author
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Author, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Author, __InBuffer);
				}
			}
		}
		...
		public TArray<FText> KeywordsTransient
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __KeywordsTransient, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __KeywordsTransient, __InBuffer);
				}
			}
		}
		...
		public TArray<FText> CategoryHierarchy
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __CategoryHierarchy, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __CategoryHierarchy, __InBuffer);
				}
			}
		}
		...
		public TArray<FText> CategoryHierarchyTransient
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __CategoryHierarchyTransient, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __CategoryHierarchyTransient, __InBuffer);
				}
			}
		}
		...
		public bool bAutoUpdateManagesInterface
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bAutoUpdateManagesInterface, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bAutoUpdateManagesInterface, __InBuffer);
				}
			}
		}
		...
		private static uint __PromptIfMissingTransient = 0;

		private static uint __Author = 0;

		private static uint __Keywords = 0;

		private static uint __KeywordsTransient = 0;

		private static uint __CategoryHierarchy = 0;

		private static uint __CategoryHierarchyTransient = 0;

		private static uint __bIsDeprecated = 0;

		private static uint __bAutoUpdateManagesInterface = 0;

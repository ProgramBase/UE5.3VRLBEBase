...
{
	[PathName("/Engine/ControlRigWrapperObject_FRigControlElement.ControlRigWrapperObject_FRigControlElement")]
	public partial class ControlRigWrapperObject_FRigControlElement : UControlRigWrapperObject, IStaticClass
	{
		...
		public FRigPreferredEulerAngles PreferredEulerAngles
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PreferredEulerAngles, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PreferredEulerAngles, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Engine/ControlRigWrapperObject_FRigControlElement.ControlRigWrapperObject_FRigControlElement");
		}

...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingStringKey")]
	public partial class UMovieSceneScriptingStringKey : UMovieSceneScriptingKey, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingStringKey");
		}
		...
		/// </param>
		public virtual void SetValue(FString InNewValue)
		{
			unsafe
			{
		...
		/// </returns>
		public virtual FString GetValue()
		{
			unsafe
			{

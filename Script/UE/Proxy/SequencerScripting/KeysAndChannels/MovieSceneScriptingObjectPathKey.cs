...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingObjectPathKey")]
	public partial class UMovieSceneScriptingObjectPathKey : UMovieSceneScriptingKey, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingObjectPathKey");
		}
		...
		/// </param>
		public virtual void SetValue(UObject InNewValue)
		{
			unsafe
			{
		...
		/// </returns>
		public virtual UObject GetValue()
		{
			unsafe
			{

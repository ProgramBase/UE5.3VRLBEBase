...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel")]
	public partial class UMovieSceneScriptingIntegerChannel : UMovieSceneScriptingChannel, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingIntegerChannel");
		}

		private static UClass StaticClassSingleton { get; set; }

		public virtual void SetDefault(int InDefaultValue)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[4];

				*(int*)(__InBuffer) = InDefaultValue;
		...
		/// <returns>
		/// An array of UMovieSceneScriptingIntegerKey's contained by this channel.
		...
		/// </returns>
		public virtual UMovieSceneScriptingIntegerKey AddKey(FFrameNumber InTime, int NewValue, float SubFrame = 0.000000f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
		{
			unsafe
			{
				...
				*(byte*)(__InBuffer + 16) = (byte)TimeUnit;
				...
				return *(UMovieSceneScriptingIntegerKey*)__ReturnBuffer;
			}
		}

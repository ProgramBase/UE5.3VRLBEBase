...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingIntegerKey")]
	public partial class UMovieSceneScriptingIntegerKey : UMovieSceneScriptingKey, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingIntegerKey");
		}
		...
		/// </param>
		public virtual void SetValue(int InNewValue)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[4];

				*(int*)(__InBuffer) = InNewValue;

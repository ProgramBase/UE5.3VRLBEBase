...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingByteKey")]
	public partial class UMovieSceneScriptingByteKey : UMovieSceneScriptingKey, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingByteKey");
		}
		...
		/// </param>
		public virtual void SetValue(byte InNewValue)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[1];

				*(byte*)(__InBuffer) = InNewValue;

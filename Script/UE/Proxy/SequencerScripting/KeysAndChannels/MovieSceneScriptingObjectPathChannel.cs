...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingObjectPathChannel")]
	public partial class UMovieSceneScriptingObjectPathChannel : UMovieSceneScriptingChannel, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingObjectPathChannel");
		}

		private static UClass StaticClassSingleton { get; set; }

		public virtual void SetDefault(UObject InDefaultValue)
		{
			unsafe
			{
		...
		/// <returns>
		/// An array of UMovieSceneScriptingObjectPathKey contained by this channel.
		...
		public virtual UObject GetDefault()
		{
			unsafe
			{
				var __ReturnBuffer = stackalloc byte[8];
		...
		/// </returns>
		public virtual UMovieSceneScriptingObjectPathKey AddKey(FFrameNumber InTime, UObject NewValue, float SubFrame = 0.000000f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
		{
			unsafe
			{
				...
				*(byte*)(__InBuffer + 20) = (byte)TimeUnit;
				...
				return *(UMovieSceneScriptingObjectPathKey*)__ReturnBuffer;
			}
		}

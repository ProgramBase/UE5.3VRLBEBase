...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingActorReferenceKey")]
	public partial class UMovieSceneScriptingActorReferenceKey : UMovieSceneScriptingKey, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingActorReferenceKey");
		}
		...
		/// </param>
		public virtual void SetValue(FMovieSceneObjectBindingID InNewValue)
		{
			unsafe
			{
		...
		/// </returns>
		public virtual FMovieSceneObjectBindingID GetValue()
		{
			unsafe
			{

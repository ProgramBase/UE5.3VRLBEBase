...
{
	[PathName("/Script/SequencerScripting.MovieSceneScriptingStringChannel")]
	public partial class UMovieSceneScriptingStringChannel : UMovieSceneScriptingChannel, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneScriptingStringChannel");
		}

		private static UClass StaticClassSingleton { get; set; }

		public virtual void SetDefault(FString InDefaultValue)
		{
			unsafe
			{
		...
		/// <returns>
		/// An array of UMovieSceneScriptingStringKey's contained by this channel.
		...
		public virtual FString GetDefault()
		{
			unsafe
			{
				var __ReturnBuffer = stackalloc byte[8];
		...
		/// </returns>
		public virtual UMovieSceneScriptingStringKey AddKey(FFrameNumber InTime, FString NewValue, float SubFrame = 0.000000f, ESequenceTimeUnit TimeUnit = ESequenceTimeUnit.DisplayRate)
		{
			unsafe
			{
				...
				*(byte*)(__InBuffer + 20) = (byte)TimeUnit;
				...
				return *(UMovieSceneScriptingStringKey*)__ReturnBuffer;
			}
		}

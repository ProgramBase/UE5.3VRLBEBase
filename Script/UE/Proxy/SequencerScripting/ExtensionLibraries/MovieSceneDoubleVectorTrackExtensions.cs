...
{
	[PathName("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions")]
	public partial class UMovieSceneDoubleVectorTrackExtensions : UBlueprintFunctionLibrary, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneDoubleVectorTrackExtensions");
		}
		...
		/// </returns>
		public static int GetNumChannelsUsed(UMovieSceneDoubleVectorTrack Track)
		{
			unsafe
			{

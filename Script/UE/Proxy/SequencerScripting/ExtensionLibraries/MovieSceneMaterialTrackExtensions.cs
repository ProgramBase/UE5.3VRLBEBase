...
{
	[PathName("/Script/SequencerScripting.MovieSceneMaterialTrackExtensions")]
	public partial class UMovieSceneMaterialTrackExtensions : UBlueprintFunctionLibrary, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/SequencerScripting.MovieSceneMaterialTrackExtensions");
		}
		...
		/// The material index.
		/// </returns>
		public static int GetMaterialIndex(UMovieSceneComponentMaterialTrack Track)
		{
			unsafe
			{

...
{
	[PathName("/Script/Landscape.LandscapeSplineSegment")]
	public partial class ULandscapeSplineSegment : UObject, IStaticClass
	{
		public FLandscapeSplineSegmentConnection Connections
		{
			get
			{
				unsafe
				{
					...
					return *(FLandscapeSplineSegmentConnection*)__ReturnBuffer;
				}
			}
		...
		public TArray<FLandscapeSplineMeshEntry> SplineMeshes
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SplineMeshes, __ReturnBuffer);

					return *(TArray<FLandscapeSplineMeshEntry>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SplineMeshes, __InBuffer);
				}
			}
		}
		...
		public FInterpCurveVector SplineInfo
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SplineInfo, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SplineInfo, __InBuffer);
				}
			}
		}
		...
		public TArray<USplineMeshComponent> LocalMeshComponents
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LocalMeshComponents, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LocalMeshComponents, __InBuffer);
				}
			}
		}
		...
		public TArray<TSoftObjectPtr<UWorld>> ForeignWorlds
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ForeignWorlds, __ReturnBuffer);

					return *(TArray<TSoftObjectPtr<UWorld>>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ForeignWorlds, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Landscape.LandscapeSplineSegment");
		}
		...
		private static uint __SplineMeshes = 0;
		...
		private static uint __SplineInfo = 0;

		private static uint __Points = 0;

		private static uint __Bounds = 0;

		private static uint __LocalMeshComponents = 0;

		private static uint __ForeignWorlds = 0;

...
{
	[PathName("/Script/Landscape.LandscapeSplineActor")]
	public partial class ALandscapeSplineActor : AActor, IStaticClass, ILandscapeSplineInterface
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Landscape.LandscapeSplineActor");
		}

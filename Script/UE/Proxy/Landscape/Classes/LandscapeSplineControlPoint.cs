...
{
	[PathName("/Script/Landscape.LandscapeSplineControlPoint")]
	public partial class ULandscapeSplineControlPoint : UObject, IStaticClass
	{
		...
		public float LayerWidthRatio
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LayerWidthRatio, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LayerWidthRatio, __InBuffer);
				}
			}
		}
		...
		public float SideFalloff
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SideFalloff, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SideFalloff, __InBuffer);
				}
			}
		}
		...
		public float LeftSideFalloffFactor
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LeftSideFalloffFactor, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LeftSideFalloffFactor, __InBuffer);
				}
			}
		}
		...
		public float RightSideFalloffFactor
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __RightSideFalloffFactor, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __RightSideFalloffFactor, __InBuffer);
				}
			}
		}
		...
		public float LeftSideLayerFalloffFactor
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LeftSideLayerFalloffFactor, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LeftSideLayerFalloffFactor, __InBuffer);
				}
			}
		}
		...
		public float RightSideLayerFalloffFactor
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __RightSideLayerFalloffFactor, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __RightSideLayerFalloffFactor, __InBuffer);
				}
			}
		}
		...
		public float EndFalloff
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __EndFalloff, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __EndFalloff, __InBuffer);
				}
			}
		}
		...
		public float SegmentMeshOffset
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SegmentMeshOffset, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SegmentMeshOffset, __InBuffer);
				}
			}
		}
		...
		public bool bRaiseTerrain
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bRaiseTerrain, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bRaiseTerrain, __InBuffer);
				}
			}
		}
		...
		public bool bLowerTerrain
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bLowerTerrain, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bLowerTerrain, __InBuffer);
				}
			}
		}
		...
		public TArray<UMaterialInterface> MaterialOverrides
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MaterialOverrides, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MaterialOverrides, __InBuffer);
				}
			}
		}
		...
		public FVector MeshScale
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MeshScale, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MeshScale, __InBuffer);
				}
			}
		}
		...
		public bool bPlaceSplineMeshesInStreamingLevels
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bPlaceSplineMeshesInStreamingLevels, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bPlaceSplineMeshesInStreamingLevels, __InBuffer);
				}
			}
		}
		...
		public bool bNavDirty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bNavDirty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bNavDirty, __InBuffer);
				}
			}
		}
		...
		public TArray<FLandscapeSplineConnection> ConnectedSegments
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ConnectedSegments, __ReturnBuffer);

					return *(TArray<FLandscapeSplineConnection>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ConnectedSegments, __InBuffer);
				}
			}
		}
		...
		public TArray<FLandscapeSplineInterpPoint> Points
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Points, __ReturnBuffer);

					return *(TArray<FLandscapeSplineInterpPoint>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Points, __InBuffer);
				}
			}
		}
		...
		public UControlPointMeshComponent LocalMeshComponent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LocalMeshComponent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LocalMeshComponent, __InBuffer);
				}
			}
		}
		...
		public TSoftObjectPtr<UWorld> ForeignWorld
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ForeignWorld, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ForeignWorld, __InBuffer);
				}
			}
		}
		...
		public FGuid ModificationKey
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ModificationKey, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ModificationKey, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Landscape.LandscapeSplineControlPoint");
		}
		...
		private static uint __LayerWidthRatio = 0;

		private static uint __SideFalloff = 0;

		private static uint __LeftSideFalloffFactor = 0;

		private static uint __RightSideFalloffFactor = 0;

		private static uint __LeftSideLayerFalloffFactor = 0;

		private static uint __RightSideLayerFalloffFactor = 0;

		private static uint __EndFalloff = 0;

		private static uint __SegmentMeshOffset = 0;

		private static uint __LayerName = 0;

		private static uint __bRaiseTerrain = 0;

		private static uint __bLowerTerrain = 0;

		private static uint __Mesh = 0;

		private static uint __MaterialOverrides = 0;

		private static uint __MeshScale = 0;

		private static uint __bCastShadow = 0;

		private static uint __bHiddenInGame = 0;

		private static uint __bPlaceSplineMeshesInStreamingLevels = 0;
		...
		private static uint __bNavDirty = 0;

		private static uint __ConnectedSegments = 0;

		private static uint __Points = 0;

		private static uint __Bounds = 0;

		private static uint __LocalMeshComponent = 0;

		private static uint __ForeignWorld = 0;

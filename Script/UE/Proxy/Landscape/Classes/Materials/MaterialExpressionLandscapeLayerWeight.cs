...
{
	[PathName("/Script/Landscape.MaterialExpressionLandscapeLayerWeight")]
	public partial class UMaterialExpressionLandscapeLayerWeight : UMaterialExpression, IStaticClass
	{
		...
		public FVector ConstBase
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ConstBase, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ConstBase, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Landscape.MaterialExpressionLandscapeLayerWeight");
		}
		...
		private static uint __ConstBase = 0;
	}
}
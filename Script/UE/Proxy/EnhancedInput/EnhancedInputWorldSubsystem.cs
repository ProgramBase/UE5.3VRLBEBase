...
{
	[PathName("/Script/EnhancedInput.EnhancedInputWorldSubsystem")]
	public partial class UEnhancedInputWorldSubsystem : UWorldSubsystem, IStaticClass, IEnhancedInputSubsystemInterface
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/EnhancedInput.EnhancedInputWorldSubsystem");
		}
		...
		public virtual bool RemoveActorInputComponent(AActor Actor)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[8];
				...
				*(nint*)(__InBuffer) = Actor?.GarbageCollectionHandle ?? nint.Zero;
				...
				FFunctionImplementation.FFunction_PrimitiveCall11Implementation(GarbageCollectionHandle, __RemoveActorInputComponent, __InBuffer, __ReturnBuffer);

				return *(bool*)__ReturnBuffer;
			}
		}

		public virtual void AddActorInputComponent(AActor Actor)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[8];
				...
				*(nint*)(__InBuffer) = Actor?.GarbageCollectionHandle ?? nint.Zero;
				...
				FFunctionImplementation.FFunction_GenericCall10Implementation(GarbageCollectionHandle, __AddActorInputComponent, __InBuffer);
			}
		}
		...
		private static uint __RemoveActorInputComponent = 0;

		private static uint __AddActorInputComponent = 0;
	}
}
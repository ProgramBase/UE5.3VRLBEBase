...
using Script.Engine;
using Script.EnhancedInput.EnhancedInputLocalPlayerSubsystem;
using Script.Library;
using Script.InputCore;

namespace Script.EnhancedInput
{
	[PathName("/Script/EnhancedInput.EnhancedInputLocalPlayerSubsystem")]
	public partial class UEnhancedInputLocalPlayerSubsystem : ULocalPlayerSubsystem, IStaticClass, IEnhancedInputSubsystemInterface
	{
		public FOnControlMappingsRebuilt ControlMappingsRebuiltDelegate
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ControlMappingsRebuiltDelegate, __ReturnBuffer);

					return *(FOnControlMappingsRebuilt*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ControlMappingsRebuiltDelegate, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/EnhancedInput.EnhancedInputLocalPlayerSubsystem");
		}
		...
		private static uint __ControlMappingsRebuiltDelegate = 0;

...
{
	[PathName("/Script/BlueprintGraph.K2Node_ComponentBoundEvent")]
	public partial class UK2Node_ComponentBoundEvent : UK2Node_Event, IStaticClass
	{
		...
		public FName ComponentPropertyName
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ComponentPropertyName, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ComponentPropertyName, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/BlueprintGraph.K2Node_ComponentBoundEvent");
		}

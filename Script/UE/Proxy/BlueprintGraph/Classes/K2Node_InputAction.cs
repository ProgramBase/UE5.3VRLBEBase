...
{
	[PathName("/Script/BlueprintGraph.K2Node_InputAction")]
	public partial class UK2Node_InputAction : UK2Node, IStaticClass, IK2Node_EventNodeInterface
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/BlueprintGraph.K2Node_InputAction");
		}

...
{
	[PathName("/Script/BlueprintGraph.K2Node_InputAxisEvent")]
	public partial class UK2Node_InputAxisEvent : UK2Node_Event, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/BlueprintGraph.K2Node_InputAxisEvent");
		}

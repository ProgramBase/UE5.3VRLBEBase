...
{
	[PathName("/Script/BlueprintGraph.K2Node_EnumLiteral")]
	public partial class UK2Node_EnumLiteral : UK2Node, IStaticClass, INodeDependingOnEnumInterface
	{
		public UEnum Enum
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/BlueprintGraph.K2Node_EnumLiteral");
		}

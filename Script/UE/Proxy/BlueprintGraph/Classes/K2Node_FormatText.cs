...
{
	[PathName("/Script/BlueprintGraph.K2Node_FormatText")]
	public partial class UK2Node_FormatText : UK2Node, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/BlueprintGraph.K2Node_FormatText");
		}

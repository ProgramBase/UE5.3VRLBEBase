...
{
	[PathName("/Script/NiagaraAnimNotifies.AnimNotify_PlayNiagaraEffect")]
	public partial class UAnimNotify_PlayNiagaraEffect : UAnimNotify, IStaticClass
	{
		...
		public bool Attached
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Attached, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Attached, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/NiagaraAnimNotifies.AnimNotify_PlayNiagaraEffect");
		}

		private static UClass StaticClassSingleton { get; set; }

		public virtual UFXSystemComponent GetSpawnedEffect()
		{
			unsafe
			{
				var __ReturnBuffer = stackalloc byte[8];

				FFunctionImplementation.FFunction_CompoundCall9Implementation(GarbageCollectionHandle, __GetSpawnedEffect, __ReturnBuffer);
		...
		private static uint __Attached = 0;

...
{
	[PathName("/Script/AITestSuite.TestBTTask_SetValue")]
	public partial class UTestBTTask_SetValue : UBTTaskNode, IStaticClass
	{
		...
		public int OnAbortValue
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __OnAbortValue, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __OnAbortValue, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AITestSuite.TestBTTask_SetValue");
		}
		...
		private static uint __OnAbortValue = 0;

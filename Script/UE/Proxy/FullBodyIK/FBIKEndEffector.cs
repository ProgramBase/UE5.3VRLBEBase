...
{
	[PathName("/Script/FullBodyIK.FBIKEndEffector")]
	public partial class FFBIKEndEffector : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/FullBodyIK.FBIKEndEffector");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FFBIKEndEffector() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FFBIKEndEffector() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FFBIKEndEffector A, FFBIKEndEffector B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FFBIKEndEffector A, FFBIKEndEffector B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FFBIKEndEffector;
		...
		public int PositionDepth
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __PositionDepth, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __PositionDepth, __InBuffer);
				}
			}
		}
		...
		public int RotationDepth
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __RotationDepth, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __RotationDepth, __InBuffer);
				}
			}
		}
		...
		public float Pull
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Pull, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Pull, __InBuffer);
				}
			}
		}
		...
		private static uint __PositionDepth = 0;

		private static uint __Rotation = 0;

		private static uint __RotationAlpha = 0;

		private static uint __RotationDepth = 0;

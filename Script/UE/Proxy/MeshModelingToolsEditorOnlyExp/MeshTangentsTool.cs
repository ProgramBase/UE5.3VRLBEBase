...
{
	[PathName("/Script/MeshModelingToolsEditorOnlyExp.MeshTangentsTool")]
	public partial class UMeshTangentsTool : USingleSelectionMeshEditingTool, IStaticClass
	{
		public UMeshTangentsToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(UMeshTangentsToolProperties*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsEditorOnlyExp.MeshTangentsTool");
		}

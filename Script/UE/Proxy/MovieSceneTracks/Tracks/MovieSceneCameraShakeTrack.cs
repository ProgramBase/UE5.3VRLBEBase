...
{
	[PathName("/Script/MovieSceneTracks.MovieSceneCameraShakeTrack")]
	public partial class UMovieSceneCameraShakeTrack : UMovieSceneNameableTrack, IStaticClass, IMovieSceneTrackTemplateProducer
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTracks.MovieSceneCameraShakeTrack");
		}

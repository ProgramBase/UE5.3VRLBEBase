...
{
	[PathName("/Script/MovieSceneTracks.MovieSceneEnumTrack")]
	public partial class UMovieSceneEnumTrack : UMovieScenePropertyTrack, IStaticClass
	{
		public UEnum Enum
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTracks.MovieSceneEnumTrack");
		}

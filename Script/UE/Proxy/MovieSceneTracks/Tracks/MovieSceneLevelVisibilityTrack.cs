...
{
	[PathName("/Script/MovieSceneTracks.MovieSceneLevelVisibilityTrack")]
	public partial class UMovieSceneLevelVisibilityTrack : UMovieSceneNameableTrack, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTracks.MovieSceneLevelVisibilityTrack");
		}

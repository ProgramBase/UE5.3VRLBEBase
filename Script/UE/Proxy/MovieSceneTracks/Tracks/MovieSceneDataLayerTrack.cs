...
{
	[PathName("/Script/MovieSceneTracks.MovieSceneDataLayerTrack")]
	public partial class UMovieSceneDataLayerTrack : UMovieSceneNameableTrack, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTracks.MovieSceneDataLayerTrack");
		}

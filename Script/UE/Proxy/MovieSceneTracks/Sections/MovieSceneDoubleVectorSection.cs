...
{
	[PathName("/Script/MovieSceneTracks.MovieSceneDoubleVectorSection")]
	public partial class UMovieSceneDoubleVectorSection : UMovieSceneSection, IStaticClass, IMovieSceneEntityProvider
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTracks.MovieSceneDoubleVectorSection");
		}

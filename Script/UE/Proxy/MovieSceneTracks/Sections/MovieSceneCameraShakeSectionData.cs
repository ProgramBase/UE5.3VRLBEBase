...
{
	[PathName("/Script/MovieSceneTracks.MovieSceneCameraShakeSectionData")]
	public partial class FMovieSceneCameraShakeSectionData : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/MovieSceneTracks.MovieSceneCameraShakeSectionData");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FMovieSceneCameraShakeSectionData() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FMovieSceneCameraShakeSectionData() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FMovieSceneCameraShakeSectionData A, FMovieSceneCameraShakeSectionData B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FMovieSceneCameraShakeSectionData A, FMovieSceneCameraShakeSectionData B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FMovieSceneCameraShakeSectionData;

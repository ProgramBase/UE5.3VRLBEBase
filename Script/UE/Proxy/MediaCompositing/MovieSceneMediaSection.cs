...
{
	[PathName("/Script/MediaCompositing.MovieSceneMediaSection")]
	public partial class UMovieSceneMediaSection : UMovieSceneSection, IStaticClass
	{
		...
		public int MediaSourceProxyIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MediaSourceProxyIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MediaSourceProxyIndex, __InBuffer);
				}
			}
		}
		...
		public UMediaSoundComponent MediaSoundComponent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MediaSoundComponent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MediaSoundComponent, __InBuffer);
				}
			}
		}
		...
		public bool bUseExternalMediaPlayer
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bUseExternalMediaPlayer, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bUseExternalMediaPlayer, __InBuffer);
				}
			}
		}
		...
		public UMediaPlayer ExternalMediaPlayer
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ExternalMediaPlayer, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ExternalMediaPlayer, __InBuffer);
				}
			}
		}
		...
		public int TextureIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __TextureIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __TextureIndex, __InBuffer);
				}
			}
		}
		...
		public bool bHasMediaPlayerProxy
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bHasMediaPlayerProxy, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bHasMediaPlayerProxy, __InBuffer);
				}
			}
		}
		...
		public FMovieSceneBoolChannel ChannelCanPlayerBeOpen
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ChannelCanPlayerBeOpen, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ChannelCanPlayerBeOpen, __InBuffer);
				}
			}
		}
		...
		public FMovieSceneObjectBindingID MediaSourceProxyBindingID
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MediaSourceProxyBindingID, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MediaSourceProxyBindingID, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MediaCompositing.MovieSceneMediaSection");
		}
		...
		private static uint __bUseExternalMediaPlayer = 0;

		private static uint __ExternalMediaPlayer = 0;

		private static uint __CacheSettings = 0;

		private static uint __TextureIndex = 0;

		private static uint __bHasMediaPlayerProxy = 0;

		private static uint __ChannelCanPlayerBeOpen = 0;

		private static uint __ThumbnailReferenceOffset = 0;

		private static uint __MediaSourceProxyBindingID = 0;
	}
}
...
{
	[PathName("/Script/MeshModelingToolsExp.TransformMeshesToolProperties")]
	public partial class UTransformMeshesToolProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public ETransformMeshesTransformMode TransformMode
		{
			get
			{
				unsafe
				{
					...
					return *(ETransformMeshesTransformMode*)__ReturnBuffer;
				}
			}
		...
		public bool bApplyToInstances
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bApplyToInstances, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bApplyToInstances, __InBuffer);
				}
			}
		}
		...
		public ETransformMeshesSnapDragSource SnapDragSource
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SnapDragSource, __ReturnBuffer);

					return *(ETransformMeshesSnapDragSource*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SnapDragSource, __InBuffer);
				}
			}
		}
		...
		public ETransformMeshesSnapDragRotationMode RotationMode
		{
			get
			{
				unsafe
				{
					...
					return *(ETransformMeshesSnapDragRotationMode*)__ReturnBuffer;
				}
			}
		...
		public bool bHaveInstances
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bHaveInstances, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bHaveInstances, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.TransformMeshesToolProperties");
		}
		...
		private static uint __bApplyToInstances = 0;

		private static uint __bSetPivotMode = 0;

		private static uint __bEnableSnapDragging = 0;

		private static uint __SnapDragSource = 0;

		private static uint __RotationMode = 0;

		private static uint __bHaveInstances = 0;
	}
}
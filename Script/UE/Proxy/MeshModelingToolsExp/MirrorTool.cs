...
{
	[PathName("/Script/MeshModelingToolsExp.MirrorTool")]
	public partial class UMirrorTool : UMultiSelectionMeshEditingTool, IStaticClass
	{
		public UMirrorToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(UMirrorToolProperties*)__ReturnBuffer;
				}
			}
		...
		public UOnAcceptHandleSourcesProperties HandleSourcesProperties
		{
			get
			{
				unsafe
				{
					...
					return *(UOnAcceptHandleSourcesProperties*)__ReturnBuffer;
				}
			}
		...
		public UMirrorToolActionPropertySet ToolActions
		{
			get
			{
				unsafe
				{
					...
					return *(UMirrorToolActionPropertySet*)__ReturnBuffer;
				}
			}
		...
		public TArray<UDynamicMeshReplacementChangeTarget> MeshesToMirror
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MeshesToMirror, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MeshesToMirror, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.MirrorTool");
		}
		...
		private static uint __MeshesToMirror = 0;

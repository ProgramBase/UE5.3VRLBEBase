...
{
	[PathName("/Script/MeshModelingToolsExp.OffsetMeshSelectionTool")]
	public partial class UOffsetMeshSelectionTool : USingleTargetWithSelectionTool, IStaticClass
	{
		public UOffsetMeshSelectionToolProperties OffsetProperties
		{
			get
			{
				unsafe
				{
					...
					return *(UOffsetMeshSelectionToolProperties*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.OffsetMeshSelectionTool");
		}

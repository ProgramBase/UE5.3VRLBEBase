...
{
	[PathName("/Script/MeshModelingToolsExp.SetCollisionGeometryTool")]
	public partial class USetCollisionGeometryTool : UMultiSelectionMeshEditingTool, IStaticClass
	{
		public USetCollisionGeometryToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(USetCollisionGeometryToolProperties*)__ReturnBuffer;
				}
			}
		...
		public UPhysicsObjectToolPropertySet CollisionProps
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CollisionProps, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CollisionProps, __InBuffer);
				}
			}
		}
		...
		public UPreviewGeometry PreviewGeom
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PreviewGeom, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PreviewGeom, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.SetCollisionGeometryTool");
		}
		...
		private static uint __CollisionProps = 0;

		private static uint __PreviewGeom = 0;
	}
}
...
{
	[PathName("/Script/MeshModelingToolsExp.ExtractCollisionGeometryTool")]
	public partial class UExtractCollisionGeometryTool : USingleSelectionMeshEditingTool, IStaticClass
	{
		...
		public UExtractCollisionToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(UExtractCollisionToolProperties*)__ReturnBuffer;
				}
			}
		...
		public UPhysicsObjectToolPropertySet ObjectProps
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ObjectProps, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ObjectProps, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.ExtractCollisionGeometryTool");
		}
		...
		private static uint __ObjectProps = 0;

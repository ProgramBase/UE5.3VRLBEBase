...
{
	[PathName("/Script/MeshModelingToolsExp.CubeGridTool")]
	public partial class UCubeGridTool : UInteractiveTool, IStaticClass, IInteractiveToolNestedAcceptCancelAPI, IInteractiveToolCameraFocusAPI
	{
		...
		public UDragAlignmentMechanic GridGizmoAlignmentMechanic
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __GridGizmoAlignmentMechanic, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __GridGizmoAlignmentMechanic, __InBuffer);
				}
			}
		}
		...
		public UTransformProxy GridGizmoTransformProxy
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __GridGizmoTransformProxy, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __GridGizmoTransformProxy, __InBuffer);
				}
			}
		}
		...
		public ULocalSingleClickInputBehavior CtrlMiddleClickBehavior
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CtrlMiddleClickBehavior, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CtrlMiddleClickBehavior, __InBuffer);
				}
			}
		}
		...
		public ULocalClickDragInputBehavior MiddleClickDragBehavior
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MiddleClickDragBehavior, __ReturnBuffer);

					return *(ULocalClickDragInputBehavior*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MiddleClickDragBehavior, __InBuffer);
				}
			}
		}
		...
		public UCubeGridToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(UCubeGridToolProperties*)__ReturnBuffer;
				}
			}
		...
		public UCubeGridToolActions ToolActions
		{
			get
			{
				unsafe
				{
					...
					return *(UCubeGridToolActions*)__ReturnBuffer;
				}
			}
		...
		public UCubeGridDuringActivityActions DuringActivityActions
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __DuringActivityActions, __ReturnBuffer);

					return *(UCubeGridDuringActivityActions*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __DuringActivityActions, __InBuffer);
				}
			}
		}
		...
		public UToolTarget Target
		{
			get
			{
				unsafe
				{
					...
					return *(UToolTarget*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.CubeGridTool");
		}
		...
		private static uint __GridGizmoAlignmentMechanic = 0;

		private static uint __GridGizmoTransformProxy = 0;
		...
		private static uint __CtrlMiddleClickBehavior = 0;

		private static uint __MiddleClickDragBehavior = 0;

		private static uint __Settings = 0;

		private static uint __ToolActions = 0;

		private static uint __DuringActivityActions = 0;

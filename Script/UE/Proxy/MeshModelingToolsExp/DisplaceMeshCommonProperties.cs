...
{
	[PathName("/Script/MeshModelingToolsExp.DisplaceMeshCommonProperties")]
	public partial class UDisplaceMeshCommonProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public EDisplaceMeshToolDisplaceType DisplacementType
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __DisplacementType, __ReturnBuffer);

					return *(EDisplaceMeshToolDisplaceType*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __DisplacementType, __InBuffer);
				}
			}
		}
		...
		public float DisplaceIntensity
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __DisplaceIntensity, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __DisplaceIntensity, __InBuffer);
				}
			}
		}
		...
		public EDisplaceMeshToolSubdivisionType SubdivisionType
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SubdivisionType, __ReturnBuffer);

					return *(EDisplaceMeshToolSubdivisionType*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SubdivisionType, __InBuffer);
				}
			}
		}
		...
		public bool bDisableSizeWarning
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bDisableSizeWarning, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bDisableSizeWarning, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.DisplaceMeshCommonProperties");
		}
		...
		private static uint __DisplacementType = 0;

		private static uint __DisplaceIntensity = 0;

		private static uint __RandomSeed = 0;

		private static uint __SubdivisionType = 0;
		...
		private static uint __bDisableSizeWarning = 0;

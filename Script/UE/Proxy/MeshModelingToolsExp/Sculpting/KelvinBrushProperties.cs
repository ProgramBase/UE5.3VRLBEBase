...
{
	[PathName("/Script/MeshModelingToolsExp.KelvinBrushProperties")]
	public partial class UKelvinBrushProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public float FallOffDistance
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __FallOffDistance, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __FallOffDistance, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.KelvinBrushProperties");
		}

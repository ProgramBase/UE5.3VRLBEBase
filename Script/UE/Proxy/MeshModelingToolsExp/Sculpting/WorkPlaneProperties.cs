...
{
	[PathName("/Script/MeshModelingToolsExp.WorkPlaneProperties")]
	public partial class UWorkPlaneProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public bool bPropertySetEnabled
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bPropertySetEnabled, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bPropertySetEnabled, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.WorkPlaneProperties");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __bPropertySetEnabled = 0;

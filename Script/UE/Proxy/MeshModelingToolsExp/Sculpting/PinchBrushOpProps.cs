...
{
	[PathName("/Script/MeshModelingToolsExp.PinchBrushOpProps")]
	public partial class UPinchBrushOpProps : UMeshSculptBrushOpProps, IStaticClass
	{
		...
		public bool bPerpDamping
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bPerpDamping, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bPerpDamping, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.PinchBrushOpProps");
		}
		...
		private static uint __bPerpDamping = 0;
	}
}
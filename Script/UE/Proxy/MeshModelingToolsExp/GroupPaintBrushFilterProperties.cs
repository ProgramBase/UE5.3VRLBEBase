...
{
	[PathName("/Script/MeshModelingToolsExp.GroupPaintBrushFilterProperties")]
	public partial class UGroupPaintBrushFilterProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public EMeshGroupPaintBrushType PrimaryBrushType
		{
			get
			{
				unsafe
				{
					...
					return *(EMeshGroupPaintBrushType*)__ReturnBuffer;
				}
			}
		...
		public EMeshGroupPaintInteractionType SubToolType
		{
			get
			{
				unsafe
				{
					...
					return *(EMeshGroupPaintInteractionType*)__ReturnBuffer;
				}
			}
		...
		public EMeshGroupPaintBrushAreaType BrushAreaMode
		{
			get
			{
				unsafe
				{
					...
					return *(EMeshGroupPaintBrushAreaType*)__ReturnBuffer;
				}
			}
		...
		public int SetGroup
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SetGroup, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SetGroup, __InBuffer);
				}
			}
		}
		...
		public bool bOnlySetUngrouped
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bOnlySetUngrouped, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bOnlySetUngrouped, __InBuffer);
				}
			}
		}
		...
		public int EraseGroup
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __EraseGroup, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __EraseGroup, __InBuffer);
				}
			}
		}
		...
		public EMeshGroupPaintVisibilityType VisibilityFilter
		{
			get
			{
				unsafe
				{
					...
					return *(EMeshGroupPaintVisibilityType*)__ReturnBuffer;
				}
			}
		...
		public bool bShowHitGroup
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bShowHitGroup, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bShowHitGroup, __InBuffer);
				}
			}
		}
		...
		public bool bShowAllGroups
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bShowAllGroups, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bShowAllGroups, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.GroupPaintBrushFilterProperties");
		}
		...
		private static uint __SetGroup = 0;

		private static uint __bOnlySetUngrouped = 0;

		private static uint __EraseGroup = 0;
		...
		private static uint __bShowHitGroup = 0;

		private static uint __bShowAllGroups = 0;
	}
}
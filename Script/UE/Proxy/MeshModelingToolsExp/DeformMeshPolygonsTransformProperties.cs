...
{
	[PathName("/Script/MeshModelingToolsExp.DeformMeshPolygonsTransformProperties")]
	public partial class UDeformMeshPolygonsTransformProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public EGroupTopologyDeformationStrategy DeformationStrategy
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __DeformationStrategy, __ReturnBuffer);

					return *(EGroupTopologyDeformationStrategy*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __DeformationStrategy, __InBuffer);
				}
			}
		}
		...
		public EQuickTransformerMode TransformMode
		{
			get
			{
				unsafe
				{
					...
					return *(EQuickTransformerMode*)__ReturnBuffer;
				}
			}
		...
		public EWeightScheme SelectedWeightScheme
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SelectedWeightScheme, __ReturnBuffer);

					return *(EWeightScheme*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = (int)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SelectedWeightScheme, __InBuffer);
				}
			}
		}
		...
		public double HandleWeight
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __HandleWeight, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(double*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __HandleWeight, __InBuffer);
				}
			}
		}
		...
		public bool bPostFixHandles
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bPostFixHandles, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bPostFixHandles, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.DeformMeshPolygonsTransformProperties");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __DeformationStrategy = 0;
		...
		private static uint __SelectedWeightScheme = 0;

		private static uint __HandleWeight = 0;

		private static uint __bPostFixHandles = 0;
	}
}
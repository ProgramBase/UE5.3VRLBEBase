...
{
	[PathName("/Script/MeshModelingToolsExp.MeshStatisticsProperties")]
	public partial class UMeshStatisticsProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public FString Mesh
		{
			get
		...
		public FString UV
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __UV, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __UV, __InBuffer);
				}
			}
		}

		public FString Attributes
		{
			get
			{
				unsafe
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.MeshStatisticsProperties");
		}

...
{
	[PathName("/Script/MeshModelingToolsExp.LatticeDeformerTool")]
	public partial class ULatticeDeformerTool : USingleSelectionMeshEditingTool, IStaticClass
	{
		public ULatticeControlPointsMechanic ControlPointsMechanic
		{
			get
			{
				unsafe
				{
					...
					return *(ULatticeControlPointsMechanic*)__ReturnBuffer;
				}
			}
		...
		public ULatticeDeformerToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(ULatticeDeformerToolProperties*)__ReturnBuffer;
				}
			}
		...
		public bool bLatticeDeformed
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bLatticeDeformed, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bLatticeDeformed, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.LatticeDeformerTool");
		}
		...
		private static uint __bLatticeDeformed = 0;
	}
}
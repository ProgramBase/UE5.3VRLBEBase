...
{
	[PathName("/Script/MeshModelingToolsExp.RevolveSplineToolProperties")]
	public partial class URevolveSplineToolProperties : URevolveProperties, IStaticClass
	{
		public ERevolveSplineSampleMode SampleMode
		{
			get
			{
				unsafe
				{
					...
					return *(ERevolveSplineSampleMode*)__ReturnBuffer;
				}
			}
		...
		public double MaxSampleDistance
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MaxSampleDistance, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(double*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MaxSampleDistance, __InBuffer);
				}
			}
		}
		...
		public bool bResetAxisOnStart
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bResetAxisOnStart, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bResetAxisOnStart, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.RevolveSplineToolProperties");
		}
		...
		private static uint __MaxSampleDistance = 0;
		...
		private static uint __bResetAxisOnStart = 0;
	}
}
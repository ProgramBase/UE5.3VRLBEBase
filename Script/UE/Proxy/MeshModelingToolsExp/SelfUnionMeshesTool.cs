...
{
	[PathName("/Script/MeshModelingToolsExp.SelfUnionMeshesTool")]
	public partial class USelfUnionMeshesTool : UBaseCreateFromSelectedTool, IStaticClass
	{
		public USelfUnionMeshesToolProperties Properties
		{
			get
			{
				unsafe
				{
					...
					return *(USelfUnionMeshesToolProperties*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.SelfUnionMeshesTool");
		}

...
{
	[PathName("/Script/MeshModelingToolsExp.WeldMeshEdgesTool")]
	public partial class UWeldMeshEdgesTool : USingleSelectionMeshEditingTool, IStaticClass
	{
		public UWeldMeshEdgesToolProperties Settings
		{
			get
			{
				unsafe
				{
					...
					return *(UWeldMeshEdgesToolProperties*)__ReturnBuffer;
				}
			}
		...
		public UWeldMeshEdgesOperatorFactory OperatorFactory
		{
			get
			{
				unsafe
				{
					...
					return *(UWeldMeshEdgesOperatorFactory*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.WeldMeshEdgesTool");
		}

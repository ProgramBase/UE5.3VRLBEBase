...
{
	[PathName("/Script/MeshModelingToolsExp.EditNormalsTool")]
	public partial class UEditNormalsTool : UMultiSelectionMeshEditingTool, IStaticClass
	{
		public UEditNormalsToolProperties BasicProperties
		{
			get
			{
				unsafe
				{
					...
					return *(UEditNormalsToolProperties*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingToolsExp.EditNormalsTool");
		}

...
{
	[PathName("/Script/TakesCore.TakeRecorderSource")]
	public partial class UTakeRecorderSource : UObject, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/TakesCore.TakeRecorderSource");
		}

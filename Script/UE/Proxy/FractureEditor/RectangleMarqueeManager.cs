...
{
	[PathName("/Script/FractureEditor.RectangleMarqueeManager")]
	public partial class URectangleMarqueeManager : UObject, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/FractureEditor.RectangleMarqueeManager");
		}

...
{
	[PathName("/Script/UMG.BackgroundBlurSlot")]
	public partial class UBackgroundBlurSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.BackgroundBlurSlot");
		}

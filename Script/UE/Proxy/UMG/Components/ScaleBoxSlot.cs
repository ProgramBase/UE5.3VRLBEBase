...
{
	[PathName("/Script/UMG.ScaleBoxSlot")]
	public partial class UScaleBoxSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.ScaleBoxSlot");
		}

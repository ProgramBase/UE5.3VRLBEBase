...
{
	[PathName("/Script/UMG.SizeBoxSlot")]
	public partial class USizeBoxSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.SizeBoxSlot");
		}

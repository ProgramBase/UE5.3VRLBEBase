...
{
	[PathName("/Script/UMG.OverlaySlot")]
	public partial class UOverlaySlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.OverlaySlot");
		}

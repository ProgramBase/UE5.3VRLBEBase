...
{
	[PathName("/Script/UMG.HorizontalBoxSlot")]
	public partial class UHorizontalBoxSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.HorizontalBoxSlot");
		}
		...
		public virtual void SetSize(FSlateChildSize InSize)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[8];

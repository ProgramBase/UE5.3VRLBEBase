...
{
	[PathName("/Script/UMG.VerticalBoxSlot")]
	public partial class UVerticalBoxSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.VerticalBoxSlot");
		}

...
{
	[PathName("/Script/UMG.ButtonSlot")]
	public partial class UButtonSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.ButtonSlot");
		}

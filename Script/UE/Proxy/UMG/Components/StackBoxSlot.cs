...
{
	[PathName("/Script/UMG.StackBoxSlot")]
	public partial class UStackBoxSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.StackBoxSlot");
		}

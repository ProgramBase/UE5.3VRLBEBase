...
{
	[PathName("/Script/UMG.ScrollBoxSlot")]
	public partial class UScrollBoxSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.ScrollBoxSlot");
		}

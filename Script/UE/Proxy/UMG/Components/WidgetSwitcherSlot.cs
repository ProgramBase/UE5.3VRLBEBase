...
{
	[PathName("/Script/UMG.WidgetSwitcherSlot")]
	public partial class UWidgetSwitcherSlot : UPanelSlot, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.WidgetSwitcherSlot");
		}

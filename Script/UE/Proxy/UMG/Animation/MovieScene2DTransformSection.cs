...
{
	[PathName("/Script/UMG.MovieScene2DTransformSection")]
	public partial class UMovieScene2DTransformSection : UMovieSceneSection, IStaticClass, IMovieSceneEntityProvider
	{
		public FMovieScene2DTransformMask TransformMask
		{
			get
			{
				unsafe
				{
					...
					return *(FMovieScene2DTransformMask*)__ReturnBuffer;
				}
			}
		...
		public FMovieSceneFloatChannel Shear
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Shear, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Shear, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UMG.MovieScene2DTransformSection");
		}

...
{
	[PathName("/Script/Renderer.SparseVolumeTextureViewerComponent")]
	public partial class USparseVolumeTextureViewerComponent : UPrimitiveComponent, IStaticClass
	{
		public USparseVolumeTexture SparseVolumeTexturePreview
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SparseVolumeTexturePreview, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SparseVolumeTexturePreview, __InBuffer);
				}
			}
		}
		...
		public bool bAnimate
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bAnimate, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bAnimate, __InBuffer);
				}
			}
		}
		...
		public float AnimationFrame
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __AnimationFrame, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __AnimationFrame, __InBuffer);
				}
			}
		}
		...
		public float AnimationTime
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __AnimationTime, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __AnimationTime, __InBuffer);
				}
			}
		}
		...
		public ESparseVolumeTexturePreviewAttribute PreviewAttribute
		{
			get
			{
				unsafe
				{
					...
					return *(ESparseVolumeTexturePreviewAttribute*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Renderer.SparseVolumeTextureViewerComponent");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __SparseVolumeTexturePreview = 0;

		private static uint __bAnimate = 0;

		private static uint __bReversePlayback = 0;

		private static uint __bBlockingStreamingRequests = 0;

		private static uint __AnimationFrame = 0;

		private static uint __FrameRate = 0;

		private static uint __AnimationTime = 0;

...
{
	[PathName("/Script/NiagaraEditor.NiagaraNodeEmitter")]
	public partial class UNiagaraNodeEmitter : UNiagaraNodeWithDynamicPins, IStaticClass
	{
		public UNiagaraSystem OwnerSystem
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __OwnerSystem, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __OwnerSystem, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/NiagaraEditor.NiagaraNodeEmitter");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __OwnerSystem = 0;

...
{
	[PathName("/Script/NiagaraEditor.NiagaraStackCategory")]
	public partial class UNiagaraStackCategory : UNiagaraStackItemContent, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/NiagaraEditor.NiagaraStackCategory");
		}

...
{
	[PathName("/Script/Sequencer.MovieSceneCopyableBinding")]
	public partial class UMovieSceneCopyableBinding : UObject, IStaticClass
	{
		public UObject SpawnableObjectTemplate
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SpawnableObjectTemplate, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SpawnableObjectTemplate, __InBuffer);
				}
			}
		}
		...
		public FMovieSceneBinding Binding
		{
			get
			{
				unsafe
				{
					...
					return *(FMovieSceneBinding*)__ReturnBuffer;
				}
			}
		...
		public FMovieSceneSpawnable Spawnable
		{
			get
			{
				unsafe
				{
					...
					return *(FMovieSceneSpawnable*)__ReturnBuffer;
				}
			}
		...
		public FMovieScenePossessable Possessable
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Possessable, __ReturnBuffer);

					return *(FMovieScenePossessable*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Possessable, __InBuffer);
				}
			}
		}

		public TArray<FString> BoundObjectNames
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __BoundObjectNames, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __BoundObjectNames, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Sequencer.MovieSceneCopyableBinding");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __SpawnableObjectTemplate = 0;
		...
		private static uint __Possessable = 0;

		private static uint __BoundObjectNames = 0;

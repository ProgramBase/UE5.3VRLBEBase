...
{
	[PathName("/Script/InteractiveToolsFramework.GizmoLineHandleComponent")]
	public partial class UGizmoLineHandleComponent : UGizmoBaseComponent, IStaticClass
	{
		...
		public float HandleSize
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __HandleSize, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __HandleSize, __InBuffer);
				}
			}
		}
		...
		public bool bImageScale
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bImageScale, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bImageScale, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InteractiveToolsFramework.GizmoLineHandleComponent");
		}
		...
		private static uint __HandleSize = 0;
		...
		private static uint __bImageScale = 0;
	}
}
...
{
	[PathName("/Script/InteractiveToolsFramework.GizmoPlaneScaleParameterSource")]
	public partial class UGizmoPlaneScaleParameterSource : UGizmoBaseVec2ParameterSource, IStaticClass
	{
		...
		public bool bUseEqualScaling
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bUseEqualScaling, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bUseEqualScaling, __InBuffer);
				}
			}
		}
		...
		public bool bClampToZero
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bClampToZero, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bClampToZero, __InBuffer);
				}
			}
		}
		...
		public FVector CurScaleOrigin
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleOrigin, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleOrigin, __InBuffer);
				}
			}
		}
		...
		public FVector CurScaleNormal
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleNormal, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleNormal, __InBuffer);
				}
			}
		}
		...
		public FVector CurScaleAxisX
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleAxisX, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleAxisX, __InBuffer);
				}
			}
		}
		...
		public FVector CurScaleAxisY
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleAxisY, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleAxisY, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InteractiveToolsFramework.GizmoPlaneScaleParameterSource");
		}
		...
		private static uint __bUseEqualScaling = 0;

		private static uint __bClampToZero = 0;

		private static uint __Parameter = 0;

		private static uint __LastChange = 0;

		private static uint __CurScaleOrigin = 0;

		private static uint __CurScaleNormal = 0;

		private static uint __CurScaleAxisX = 0;

		private static uint __CurScaleAxisY = 0;

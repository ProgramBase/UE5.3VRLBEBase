...
{
	[PathName("/Script/InteractiveToolsFramework.AxisPositionGizmo")]
	public partial class UAxisPositionGizmo : UInteractiveGizmo, IStaticClass
	{
		...
		public TScriptInterface<IGizmoFloatParameterSource> ParameterSource
		{
			get
			{
				unsafe
		...
		public FVector InteractionAxis
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __InteractionAxis, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __InteractionAxis, __InBuffer);
				}
			}
		}
		...
		public float ParameterSign
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ParameterSign, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ParameterSign, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InteractiveToolsFramework.AxisPositionGizmo");
		}
		...
		private static uint __InteractionAxis = 0;
		...
		private static uint __ParameterSign = 0;
	}
}
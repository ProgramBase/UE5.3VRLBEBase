...
{
	[PathName("/Script/InteractiveToolsFramework.GizmoBoxComponent")]
	public partial class UGizmoBoxComponent : UGizmoBaseComponent, IStaticClass
	{
		...
		public bool bRemoveHiddenLines
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bRemoveHiddenLines, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bRemoveHiddenLines, __InBuffer);
				}
			}
		}
		...
		public bool bEnableAxisFlip
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bEnableAxisFlip, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bEnableAxisFlip, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InteractiveToolsFramework.GizmoBoxComponent");
		}
		...
		private static uint __bRemoveHiddenLines = 0;

		private static uint __bEnableAxisFlip = 0;
	}
}
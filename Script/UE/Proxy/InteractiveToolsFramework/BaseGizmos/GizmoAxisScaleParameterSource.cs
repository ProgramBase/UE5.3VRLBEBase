...
{
	[PathName("/Script/InteractiveToolsFramework.GizmoAxisScaleParameterSource")]
	public partial class UGizmoAxisScaleParameterSource : UGizmoBaseFloatParameterSource, IStaticClass
	{
		...
		public FVector CurScaleAxis
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleAxis, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CurScaleAxis, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InteractiveToolsFramework.GizmoAxisScaleParameterSource");
		}
		...
		private static uint __CurScaleAxis = 0;

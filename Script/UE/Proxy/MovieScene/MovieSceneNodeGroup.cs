...
{
	[PathName("/Script/MovieScene.MovieSceneNodeGroup")]
	public partial class UMovieSceneNodeGroup : UObject, IStaticClass
	{
		public FName Name
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieScene.MovieSceneNodeGroup");
		}

...
{
	[PathName("/Script/MovieScene.TestMovieSceneEvalHookTrack")]
	public partial class UTestMovieSceneEvalHookTrack : UMovieSceneTrack, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieScene.TestMovieSceneEvalHookTrack");
		}

...
{
	[PathName("/Script/MovieScene.MovieSceneFloatChannel")]
	public partial class FMovieSceneFloatChannel : FMovieSceneChannel, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/MovieScene.MovieSceneFloatChannel");
		}
		...
		public static bool operator ==(FMovieSceneFloatChannel A, FMovieSceneFloatChannel B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FMovieSceneFloatChannel A, FMovieSceneFloatChannel B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FMovieSceneFloatChannel;
		...
		public TArray<FMovieSceneFloatValue> Values
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<FMovieSceneFloatValue>*)__ReturnBuffer;
				}
			}

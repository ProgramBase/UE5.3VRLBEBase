...
{
	[PathName("/Script/ModelingComponents.UVLayoutPreviewProperties")]
	public partial class UUVLayoutPreviewProperties : UInteractiveToolPropertySet, IStaticClass
	{
		...
		public EUVLayoutPreviewSide Side
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Side, __ReturnBuffer);

					return *(EUVLayoutPreviewSide*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = (int)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Side, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/ModelingComponents.UVLayoutPreviewProperties");
		}

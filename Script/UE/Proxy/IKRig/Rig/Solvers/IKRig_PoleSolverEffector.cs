...
{
	[PathName("/Script/IKRig.IKRig_PoleSolverEffector")]
	public partial class UIKRig_PoleSolverEffector : UObject, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/IKRig.IKRig_PoleSolverEffector");
		}

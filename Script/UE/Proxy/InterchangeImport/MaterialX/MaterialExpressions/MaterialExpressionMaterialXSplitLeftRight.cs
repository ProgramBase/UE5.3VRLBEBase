...
{
	[PathName("/Script/InterchangeImport.MaterialExpressionMaterialXSplitLeftRight")]
	public partial class UMaterialExpressionMaterialXSplitLeftRight : UMaterialExpression, IStaticClass
	{
		...
		public float ConstCenter
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ConstCenter, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ConstCenter, __InBuffer);
				}
			}
		}
		...
		public byte ConstCoordinate
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ConstCoordinate, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ConstCoordinate, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InterchangeImport.MaterialExpressionMaterialXSplitLeftRight");
		}
		...
		private static uint __ConstCenter = 0;

		private static uint __ConstCoordinate = 0;
	}
}
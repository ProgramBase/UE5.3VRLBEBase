...
{
	[PathName("/Script/AnimationData.AnimSequencerController")]
	public partial class UAnimSequencerController : UObject, IStaticClass, IAnimationDataController
	{
		public TWeakObjectPtr<UAnimationSequencerDataModel> Model
		{
			get
			{
				unsafe
				{
					...
					return *(TWeakObjectPtr<UAnimationSequencerDataModel>*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AnimationData.AnimSequencerController");
		}

...
{
	[PathName("/Script/GeometryCollectionNodes.AddDataflowNode")]
	public partial class FAddDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.AddDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FAddDataflowNode()
		{
		}

		public static bool operator ==(FAddDataflowNode A, FAddDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FAddDataflowNode A, FAddDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FAddDataflowNode;

...
{
	[PathName("/Script/GeometryCollectionNodes.ClampDataflowNode")]
	public partial class FClampDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.ClampDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FClampDataflowNode()
		{
		}

		public static bool operator ==(FClampDataflowNode A, FClampDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FClampDataflowNode A, FClampDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FClampDataflowNode;

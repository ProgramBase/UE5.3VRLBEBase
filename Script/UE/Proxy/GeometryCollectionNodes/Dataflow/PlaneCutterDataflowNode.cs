...
{
	[PathName("/Script/GeometryCollectionNodes.PlaneCutterDataflowNode")]
	public partial class FPlaneCutterDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.PlaneCutterDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FPlaneCutterDataflowNode()
		{
		}

		public static bool operator ==(FPlaneCutterDataflowNode A, FPlaneCutterDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FPlaneCutterDataflowNode A, FPlaneCutterDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FPlaneCutterDataflowNode;
		...
		public int NumPlanes
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __NumPlanes, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __NumPlanes, __InBuffer);
				}
			}
		}
		...
		private static uint __NumPlanes = 0;

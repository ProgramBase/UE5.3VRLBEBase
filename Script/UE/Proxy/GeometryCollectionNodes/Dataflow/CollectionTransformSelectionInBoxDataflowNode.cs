...
{
	[PathName("/Script/GeometryCollectionNodes.CollectionTransformSelectionInBoxDataflowNode")]
	public partial class FCollectionTransformSelectionInBoxDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.CollectionTransformSelectionInBoxDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FCollectionTransformSelectionInBoxDataflowNode()
		{
		}

		public static bool operator ==(FCollectionTransformSelectionInBoxDataflowNode A, FCollectionTransformSelectionInBoxDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FCollectionTransformSelectionInBoxDataflowNode A, FCollectionTransformSelectionInBoxDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FCollectionTransformSelectionInBoxDataflowNode;
		...
		public bool bAllVerticesMustContainedInBox
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bAllVerticesMustContainedInBox, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bAllVerticesMustContainedInBox, __InBuffer);
				}
			}
		}
		...
		private static uint __bAllVerticesMustContainedInBox = 0;

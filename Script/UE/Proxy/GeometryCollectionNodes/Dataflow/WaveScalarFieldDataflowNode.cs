...
{
	[PathName("/Script/GeometryCollectionNodes.WaveScalarFieldDataflowNode")]
	public partial class FWaveScalarFieldDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.WaveScalarFieldDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FWaveScalarFieldDataflowNode()
		{
		}

		public static bool operator ==(FWaveScalarFieldDataflowNode A, FWaveScalarFieldDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FWaveScalarFieldDataflowNode A, FWaveScalarFieldDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FWaveScalarFieldDataflowNode;
		...
		public float Wavelength
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Wavelength, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Wavelength, __InBuffer);
				}
			}
		}
		...
		public float Period
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Period, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Period, __InBuffer);
				}
			}
		}
		...
		public EDataflowWaveFunctionType FunctionType
		{
			get
			{
				unsafe
				{
					...
					return *(EDataflowWaveFunctionType*)__ReturnBuffer;
				}
			}

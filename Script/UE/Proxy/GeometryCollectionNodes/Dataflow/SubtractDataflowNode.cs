...
{
	[PathName("/Script/GeometryCollectionNodes.SubtractDataflowNode")]
	public partial class FSubtractDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.SubtractDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FSubtractDataflowNode()
		{
		}

		public static bool operator ==(FSubtractDataflowNode A, FSubtractDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FSubtractDataflowNode A, FSubtractDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FSubtractDataflowNode;

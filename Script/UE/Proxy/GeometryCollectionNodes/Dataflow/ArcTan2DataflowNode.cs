...
{
	[PathName("/Script/GeometryCollectionNodes.ArcTan2DataflowNode")]
	public partial class FArcTan2DataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.ArcTan2DataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FArcTan2DataflowNode()
		{
		}

		public static bool operator ==(FArcTan2DataflowNode A, FArcTan2DataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FArcTan2DataflowNode A, FArcTan2DataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FArcTan2DataflowNode;

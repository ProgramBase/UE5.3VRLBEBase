...
{
	[PathName("/Script/GeometryCollectionNodes.CollectionTransformSelectionInSphereDataflowNode")]
	public partial class FCollectionTransformSelectionInSphereDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.CollectionTransformSelectionInSphereDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FCollectionTransformSelectionInSphereDataflowNode()
		{
		}

		public static bool operator ==(FCollectionTransformSelectionInSphereDataflowNode A, FCollectionTransformSelectionInSphereDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FCollectionTransformSelectionInSphereDataflowNode A, FCollectionTransformSelectionInSphereDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FCollectionTransformSelectionInSphereDataflowNode;
		...
		public ESelectSubjectTypeEnum Type
		{
			get
			{
				unsafe
				{
					...
					return *(ESelectSubjectTypeEnum*)__ReturnBuffer;
				}
			}
		...
		public bool bAllVerticesMustContainedInSphere
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bAllVerticesMustContainedInSphere, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bAllVerticesMustContainedInSphere, __InBuffer);
				}
			}
		}
		...
		private static uint __bAllVerticesMustContainedInSphere = 0;

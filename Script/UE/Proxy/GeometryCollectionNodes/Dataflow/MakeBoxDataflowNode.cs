...
{
	[PathName("/Script/GeometryCollectionNodes.MakeBoxDataflowNode")]
	public partial class FMakeBoxDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.MakeBoxDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FMakeBoxDataflowNode()
		{
		}

		public static bool operator ==(FMakeBoxDataflowNode A, FMakeBoxDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FMakeBoxDataflowNode A, FMakeBoxDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FMakeBoxDataflowNode;
		...
		public EMakeBoxDataTypeEnum DataType
		{
			get
			{
				unsafe
				{
					...
					return *(EMakeBoxDataTypeEnum*)__ReturnBuffer;
				}
			}

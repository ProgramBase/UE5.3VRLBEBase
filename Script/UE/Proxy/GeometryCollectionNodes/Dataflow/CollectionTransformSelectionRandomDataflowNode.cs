...
{
	[PathName("/Script/GeometryCollectionNodes.CollectionTransformSelectionRandomDataflowNode")]
	public partial class FCollectionTransformSelectionRandomDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.CollectionTransformSelectionRandomDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FCollectionTransformSelectionRandomDataflowNode()
		{
		}

		public static bool operator ==(FCollectionTransformSelectionRandomDataflowNode A, FCollectionTransformSelectionRandomDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FCollectionTransformSelectionRandomDataflowNode A, FCollectionTransformSelectionRandomDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FCollectionTransformSelectionRandomDataflowNode;
		...
		public float RandomThreshold
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __RandomThreshold, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __RandomThreshold, __InBuffer);
				}
			}
		}
		...
		private static uint __RandomThreshold = 0;

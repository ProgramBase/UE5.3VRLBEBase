...
{
	[PathName("/Script/GeometryCollectionNodes.RadialFalloffFieldDataflowNode")]
	public partial class FRadialFalloffFieldDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.RadialFalloffFieldDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRadialFalloffFieldDataflowNode()
		{
		}

		public static bool operator ==(FRadialFalloffFieldDataflowNode A, FRadialFalloffFieldDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRadialFalloffFieldDataflowNode A, FRadialFalloffFieldDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRadialFalloffFieldDataflowNode;
		...
		public EDataflowFieldFalloffType FalloffType
		{
			get
			{
				unsafe
				{
					...
					return *(EDataflowFieldFalloffType*)__ReturnBuffer;
				}
			}
		...
		public FDataflowVertexSelection FieldSelectionMask
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __FieldSelectionMask, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __FieldSelectionMask, __InBuffer);
				}
			}
		}
		...
		private static uint __FieldSelectionMask = 0;

...
{
	[PathName("/Script/GeometryCollectionNodes.CollectionSelectionConvertDataflowNode")]
	public partial class FCollectionSelectionConvertDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.CollectionSelectionConvertDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FCollectionSelectionConvertDataflowNode()
		{
		}

		public static bool operator ==(FCollectionSelectionConvertDataflowNode A, FCollectionSelectionConvertDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FCollectionSelectionConvertDataflowNode A, FCollectionSelectionConvertDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FCollectionSelectionConvertDataflowNode;
		...
		public bool bAllElementsMustBeSelected
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bAllElementsMustBeSelected, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bAllElementsMustBeSelected, __InBuffer);
				}
			}
		}
		...
		private static uint __bAllElementsMustBeSelected = 0;

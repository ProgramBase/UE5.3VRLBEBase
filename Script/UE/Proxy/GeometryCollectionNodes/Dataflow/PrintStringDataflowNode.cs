...
{
	[PathName("/Script/GeometryCollectionNodes.PrintStringDataflowNode")]
	public partial class FPrintStringDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.PrintStringDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FPrintStringDataflowNode()
		{
		}

		public static bool operator ==(FPrintStringDataflowNode A, FPrintStringDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FPrintStringDataflowNode A, FPrintStringDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FPrintStringDataflowNode;
		...
		public bool bPrintToScreen
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bPrintToScreen, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bPrintToScreen, __InBuffer);
				}
			}
		}
		...
		private static uint __bPrintToScreen = 0;

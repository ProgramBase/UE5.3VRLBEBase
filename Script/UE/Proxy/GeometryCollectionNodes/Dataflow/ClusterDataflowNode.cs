...
{
	[PathName("/Script/GeometryCollectionNodes.ClusterDataflowNode")]
	public partial class FClusterDataflowNode : FDataflowNode, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/GeometryCollectionNodes.ClusterDataflowNode");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FClusterDataflowNode()
		{
		}

		public static bool operator ==(FClusterDataflowNode A, FClusterDataflowNode B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FClusterDataflowNode A, FClusterDataflowNode B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FClusterDataflowNode;

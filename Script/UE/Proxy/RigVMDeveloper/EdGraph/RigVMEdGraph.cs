...
{
	[PathName("/Script/RigVMDeveloper.RigVMEdGraph")]
	public partial class URigVMEdGraph : UEdGraph, IStaticClass, IRigVMEditorSideObject
	{
		...
		public bool bIsFunctionDefinition
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bIsFunctionDefinition, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bIsFunctionDefinition, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/RigVMDeveloper.RigVMEdGraph");
		}
		...
		private static uint __bIsFunctionDefinition = 0;

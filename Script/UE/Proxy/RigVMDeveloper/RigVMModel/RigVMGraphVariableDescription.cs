...
{
	[PathName("/Script/RigVMDeveloper.RigVMGraphVariableDescription")]
	public partial class FRigVMGraphVariableDescription : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVMDeveloper.RigVMGraphVariableDescription");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMGraphVariableDescription() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FRigVMGraphVariableDescription() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FRigVMGraphVariableDescription A, FRigVMGraphVariableDescription B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMGraphVariableDescription A, FRigVMGraphVariableDescription B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMGraphVariableDescription;

...
{
	[PathName("/Script/MovieSceneTools.MovieSceneUserImportFBXSettings")]
	public partial class UMovieSceneUserImportFBXSettings : UObject, IStaticClass
	{
		public bool bMatchByNameOnly
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bMatchByNameOnly, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bMatchByNameOnly, __InBuffer);
				}
			}
		}
		...
		public bool bCreateCameras
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bCreateCameras, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bCreateCameras, __InBuffer);
				}
			}
		}
		...
		public bool bReplaceTransformTrack
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bReplaceTransformTrack, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bReplaceTransformTrack, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTools.MovieSceneUserImportFBXSettings");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __bMatchByNameOnly = 0;
		...
		private static uint __bCreateCameras = 0;

		private static uint __bReplaceTransformTrack = 0;

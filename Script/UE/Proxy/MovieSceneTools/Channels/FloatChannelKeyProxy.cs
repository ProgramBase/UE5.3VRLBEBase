...
{
	[PathName("/Script/MovieSceneTools.FloatChannelKeyProxy")]
	public partial class UFloatChannelKeyProxy : UObject, IStaticClass, ICurveEditorKeyProxy, IMovieSceneKeyProxy
	{
		...
		public FMovieSceneFloatValue Value
		{
			get
			{
				unsafe
				{
					...
					return *(FMovieSceneFloatValue*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTools.FloatChannelKeyProxy");
		}

...
{
	[PathName("/Script/MovieSceneTools.DoubleChannelKeyProxy")]
	public partial class UDoubleChannelKeyProxy : UObject, IStaticClass, ICurveEditorKeyProxy, IMovieSceneKeyProxy
	{
		...
		public FMovieSceneDoubleValue Value
		{
			get
			{
				unsafe
				{
					...
					return *(FMovieSceneDoubleValue*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MovieSceneTools.DoubleChannelKeyProxy");
		}

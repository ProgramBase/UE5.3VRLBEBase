...
{
	[PathName("/Script/RigVM.RigVMFunction_AlphaInterpVector")]
	public partial class FRigVMFunction_AlphaInterpVector : FRigVMFunction_SimBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_AlphaInterpVector");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_AlphaInterpVector()
		{
		}

		public static bool operator ==(FRigVMFunction_AlphaInterpVector A, FRigVMFunction_AlphaInterpVector B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_AlphaInterpVector A, FRigVMFunction_AlphaInterpVector B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_AlphaInterpVector;

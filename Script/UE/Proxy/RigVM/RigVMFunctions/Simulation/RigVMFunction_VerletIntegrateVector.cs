...
{
	[PathName("/Script/RigVM.RigVMFunction_VerletIntegrateVector")]
	public partial class FRigVMFunction_VerletIntegrateVector : FRigVMFunction_SimBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_VerletIntegrateVector");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_VerletIntegrateVector()
		{
		}

		public static bool operator ==(FRigVMFunction_VerletIntegrateVector A, FRigVMFunction_VerletIntegrateVector B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_VerletIntegrateVector A, FRigVMFunction_VerletIntegrateVector B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_VerletIntegrateVector;
		...
		public float Damp
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Damp, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Damp, __InBuffer);
				}
			}
		}
		...
		public FRigVMSimPoint Point
		{
			get
			{
				unsafe
				{
					...
					return *(FRigVMSimPoint*)__ReturnBuffer;
				}
			}

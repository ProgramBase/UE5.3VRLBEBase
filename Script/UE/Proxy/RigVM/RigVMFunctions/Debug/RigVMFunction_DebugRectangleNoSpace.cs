...
{
	[PathName("/Script/RigVM.RigVMFunction_DebugRectangleNoSpace")]
	public partial class FRigVMFunction_DebugRectangleNoSpace : FRigVMFunction_DebugBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_DebugRectangleNoSpace");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_DebugRectangleNoSpace()
		{
		}

		public static bool operator ==(FRigVMFunction_DebugRectangleNoSpace A, FRigVMFunction_DebugRectangleNoSpace B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_DebugRectangleNoSpace A, FRigVMFunction_DebugRectangleNoSpace B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_DebugRectangleNoSpace;

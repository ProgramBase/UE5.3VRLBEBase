...
{
	[PathName("/Script/RigVM.RigVMFunction_VisualDebugTransform")]
	public partial class FRigVMFunction_VisualDebugTransform : FRigVMFunction_DebugBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_VisualDebugTransform");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_VisualDebugTransform()
		{
		}

		public static bool operator ==(FRigVMFunction_VisualDebugTransform A, FRigVMFunction_VisualDebugTransform B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_VisualDebugTransform A, FRigVMFunction_VisualDebugTransform B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_VisualDebugTransform;

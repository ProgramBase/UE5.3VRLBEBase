...
{
	[PathName("/Script/RigVM.RigVMFunction_VisualDebugVector")]
	public partial class FRigVMFunction_VisualDebugVector : FRigVMFunction_DebugBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_VisualDebugVector");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_VisualDebugVector()
		{
		}

		public static bool operator ==(FRigVMFunction_VisualDebugVector A, FRigVMFunction_VisualDebugVector B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_VisualDebugVector A, FRigVMFunction_VisualDebugVector B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_VisualDebugVector;
		...
		public ERigUnitVisualDebugPointMode Mode
		{
			get
			{
				unsafe
				{
					...
					return *(ERigUnitVisualDebugPointMode*)__ReturnBuffer;
				}
			}

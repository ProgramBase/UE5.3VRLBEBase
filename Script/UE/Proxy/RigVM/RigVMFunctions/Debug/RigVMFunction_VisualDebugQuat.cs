...
{
	[PathName("/Script/RigVM.RigVMFunction_VisualDebugQuat")]
	public partial class FRigVMFunction_VisualDebugQuat : FRigVMFunction_DebugBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_VisualDebugQuat");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_VisualDebugQuat()
		{
		}

		public static bool operator ==(FRigVMFunction_VisualDebugQuat A, FRigVMFunction_VisualDebugQuat B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_VisualDebugQuat A, FRigVMFunction_VisualDebugQuat B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_VisualDebugQuat;

...
{
	[PathName("/Script/RigVM.RigVMFunction_DebugPoint")]
	public partial class FRigVMFunction_DebugPoint : FRigVMFunction_DebugBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMFunction_DebugPoint");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMFunction_DebugPoint()
		{
		}

		public static bool operator ==(FRigVMFunction_DebugPoint A, FRigVMFunction_DebugPoint B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMFunction_DebugPoint A, FRigVMFunction_DebugPoint B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMFunction_DebugPoint;
		...
		public ERigUnitDebugPointMode Mode
		{
			get
			{
				unsafe
				{
					...
					return *(ERigUnitDebugPointMode*)__ReturnBuffer;
				}
			}

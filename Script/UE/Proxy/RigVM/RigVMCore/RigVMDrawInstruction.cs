...
{
	[PathName("/Script/RigVM.RigVMDrawInstruction")]
	public partial class FRigVMDrawInstruction : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/RigVM.RigVMDrawInstruction");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigVMDrawInstruction() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FRigVMDrawInstruction() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FRigVMDrawInstruction A, FRigVMDrawInstruction B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigVMDrawInstruction A, FRigVMDrawInstruction B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigVMDrawInstruction;
		...
		public ERigVMDrawSettings PrimitiveType
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __PrimitiveType, __ReturnBuffer);

					return *(ERigVMDrawSettings*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __PrimitiveType, __InBuffer);
				}
			}
		}

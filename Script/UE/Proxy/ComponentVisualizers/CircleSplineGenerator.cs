...
{
	[PathName("/Script/ComponentVisualizers.CircleSplineGenerator")]
	public partial class UCircleSplineGenerator : USplineGeneratorBase, IStaticClass
	{
		...
		public bool bReverseDir
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bReverseDir, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bReverseDir, __InBuffer);
				}
			}
		}
		...
		public bool bKeepFirstKeyTangent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bKeepFirstKeyTangent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bKeepFirstKeyTangent, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/ComponentVisualizers.CircleSplineGenerator");
		}
		...
		private static uint __bReverseDir = 0;

		private static uint __bKeepFirstKeyTangent = 0;

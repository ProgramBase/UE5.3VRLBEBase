...
{
	[PathName("/Script/InterchangeEngine.InterchangeSceneImportAsset")]
	public partial class UInterchangeSceneImportAsset : UObject, IStaticClass, IInterface_AssetUserData
	{
		public UInterchangeAssetImportData AssetImportData
		{
			get
			{
				unsafe
				{
					...
					return *(UInterchangeAssetImportData*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/InterchangeEngine.InterchangeSceneImportAsset");
		}

...
{
	[PathName("/Script/DatasmithContent.DatasmithAreaLightActorTemplate")]
	public partial class UDatasmithAreaLightActorTemplate : UDatasmithObjectTemplate, IStaticClass
	{
		...
		public TSoftObjectPtr<UTextureLightProfile> IESTexture
		{
			get
			{
				unsafe
				{
					...
					return *(TSoftObjectPtr<UTextureLightProfile>*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/DatasmithContent.DatasmithAreaLightActorTemplate");
		}

...
{
	[PathName("/Script/DatasmithContent.DatasmithGLTFSceneImportData")]
	public partial class UDatasmithGLTFSceneImportData : UDatasmithSceneImportData, IStaticClass
	{
		public FString Generator
		{
			get
			{
				unsafe
		...
		public FString License
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __License, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __License, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/DatasmithContent.DatasmithGLTFSceneImportData");
		}
		...
		private static uint __License = 0;

...
{
	[PathName("/Script/ChaosSolverEngine.ChaosPhysicsCollisionInfo")]
	public partial class FChaosPhysicsCollisionInfo : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ChaosSolverEngine.ChaosPhysicsCollisionInfo");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FChaosPhysicsCollisionInfo() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FChaosPhysicsCollisionInfo() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FChaosPhysicsCollisionInfo A, FChaosPhysicsCollisionInfo B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FChaosPhysicsCollisionInfo A, FChaosPhysicsCollisionInfo B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FChaosPhysicsCollisionInfo;
		...
		public UPrimitiveComponent OtherComponent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __OtherComponent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __OtherComponent, __InBuffer);
				}
			}
		}
		...
		public FVector OtherVelocity
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __OtherVelocity, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __OtherVelocity, __InBuffer);
				}
			}
		}
		...
		public FVector OtherAngularVelocity
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __OtherAngularVelocity, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __OtherAngularVelocity, __InBuffer);
				}
			}
		}
		...
		public float OtherMass
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __OtherMass, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __OtherMass, __InBuffer);
				}
			}
		}
		...
		private static uint __OtherComponent = 0;
		...
		private static uint __OtherVelocity = 0;

		private static uint __AngularVelocity = 0;

		private static uint __OtherAngularVelocity = 0;

		private static uint __Mass = 0;

		private static uint __OtherMass = 0;

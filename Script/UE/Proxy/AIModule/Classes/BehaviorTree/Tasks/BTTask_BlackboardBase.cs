...
{
	[PathName("/Script/AIModule.BTTask_BlackboardBase")]
	public partial class UBTTask_BlackboardBase : UBTTaskNode, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AIModule.BTTask_BlackboardBase");
		}

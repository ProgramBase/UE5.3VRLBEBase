...
{
	[PathName("/Script/AIModule.BTTask_SetTagCooldown")]
	public partial class UBTTask_SetTagCooldown : UBTTaskNode, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AIModule.BTTask_SetTagCooldown");
		}

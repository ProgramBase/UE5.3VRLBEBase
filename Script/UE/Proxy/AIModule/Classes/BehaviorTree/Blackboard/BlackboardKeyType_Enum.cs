...
{
	[PathName("/Script/AIModule.BlackboardKeyType_Enum")]
	public partial class UBlackboardKeyType_Enum : UBlackboardKeyType, IStaticClass
	{
		...
		public bool bIsEnumNameValid
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bIsEnumNameValid, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bIsEnumNameValid, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AIModule.BlackboardKeyType_Enum");
		}
		...
		private static uint __bIsEnumNameValid = 0;
	}
}
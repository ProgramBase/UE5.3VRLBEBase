...
{
	[PathName("/Script/AIModule.BTDecorator_TagCooldown")]
	public partial class UBTDecorator_TagCooldown : UBTDecorator, IStaticClass
	{
		...
		public bool bActivatesCooldown
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bActivatesCooldown, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bActivatesCooldown, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AIModule.BTDecorator_TagCooldown");
		}
		...
		private static uint __bActivatesCooldown = 0;
	}
}
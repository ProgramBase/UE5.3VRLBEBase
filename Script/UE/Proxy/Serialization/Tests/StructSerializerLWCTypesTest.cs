...
{
	[PathName("/Script/Serialization.StructSerializerLWCTypesTest")]
	public partial class FStructSerializerLWCTypesTest : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Serialization.StructSerializerLWCTypesTest");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FStructSerializerLWCTypesTest() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FStructSerializerLWCTypesTest() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FStructSerializerLWCTypesTest A, FStructSerializerLWCTypesTest B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FStructSerializerLWCTypesTest A, FStructSerializerLWCTypesTest B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FStructSerializerLWCTypesTest;
		...
		public FOrientedBox OrientedBox
		{
			get
			{
				unsafe
				{
					...
					return *(FOrientedBox*)__ReturnBuffer;
				}
			}

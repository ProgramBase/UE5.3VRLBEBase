...
{
	[PathName("/Script/ModelingOperators.UVLayoutProperties")]
	public partial class UUVLayoutProperties : UInteractiveToolPropertySet, IStaticClass
	{
		public EUVLayoutType LayoutType
		{
			get
			{
				unsafe
				{
					...
					return *(EUVLayoutType*)__ReturnBuffer;
				}
			}
		...
		public bool bAllowFlips
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bAllowFlips, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bAllowFlips, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/ModelingOperators.UVLayoutProperties");
		}
		...
		private static uint __bAllowFlips = 0;

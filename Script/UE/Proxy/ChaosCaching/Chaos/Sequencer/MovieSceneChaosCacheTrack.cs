...
{
	[PathName("/Script/ChaosCaching.MovieSceneChaosCacheTrack")]
	public partial class UMovieSceneChaosCacheTrack : UMovieSceneNameableTrack, IStaticClass, IMovieSceneTrackTemplateProducer
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/ChaosCaching.MovieSceneChaosCacheTrack");
		}

...
{
	[PathName("/Script/ChaosCaching.CollisionEvent")]
	public partial class FCollisionEvent : FCacheEventBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ChaosCaching.CollisionEvent");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FCollisionEvent()
		{
		}

		public static bool operator ==(FCollisionEvent A, FCollisionEvent B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FCollisionEvent A, FCollisionEvent B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FCollisionEvent;
		...
		public FVector DeltaVelocity1
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __DeltaVelocity1, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __DeltaVelocity1, __InBuffer);
				}
			}
		}
		...
		public FVector DeltaVelocity2
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __DeltaVelocity2, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __DeltaVelocity2, __InBuffer);
				}
			}
		}
		...
		private static uint __DeltaVelocity1 = 0;

		private static uint __DeltaVelocity2 = 0;

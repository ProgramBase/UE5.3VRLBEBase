...
{
	[PathName("/Script/Engine.PostProcessVolume")]
	public partial class APostProcessVolume : AVolume, IStaticClass, IInterface_PostProcessVolume
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.PostProcessVolume");
		}

...
{
	[PathName("/Script/Engine.ReflectionCapture")]
	public partial class AReflectionCapture : AActor, IStaticClass
	{
		public UReflectionCaptureComponent CaptureComponent
		{
			get
			{
				unsafe
				{
					...
					return *(UReflectionCaptureComponent*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ReflectionCapture");
		}

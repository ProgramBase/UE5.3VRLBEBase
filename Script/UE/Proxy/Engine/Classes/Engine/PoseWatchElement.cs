...
{
	[PathName("/Script/Engine.PoseWatchElement")]
	public partial class UPoseWatchElement : UObject, IStaticClass
	{
		...
		public bool bHasColor
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bHasColor, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bHasColor, __InBuffer);
				}
			}
		}
		...
		public FName IconName
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __IconName, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __IconName, __InBuffer);
				}
			}
		}
		...
		public TWeakObjectPtr<UPoseWatch> Parent
		{
			get
			{
				unsafe
				{
					...
					return *(TWeakObjectPtr<UPoseWatch>*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.PoseWatchElement");
		}
		...
		private static uint __bHasColor = 0;

		private static uint __Color = 0;

		private static uint __Label = 0;

		private static uint __IconName = 0;

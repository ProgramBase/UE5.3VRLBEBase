...
{
	[PathName("/Script/Engine.StaticMeshSocket")]
	public partial class UStaticMeshSocket : UObject, IStaticClass
	{
		...
		public UStaticMesh PreviewStaticMesh
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PreviewStaticMesh, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PreviewStaticMesh, __InBuffer);
				}
			}
		}
		...
		public bool bSocketCreatedAtImport
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bSocketCreatedAtImport, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bSocketCreatedAtImport, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.StaticMeshSocket");
		}
		...
		private static uint __PreviewStaticMesh = 0;

		private static uint __bSocketCreatedAtImport = 0;
	}
}
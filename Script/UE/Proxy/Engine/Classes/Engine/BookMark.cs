...
{
	[PathName("/Script/Engine.BookMark")]
	public partial class UBookMark : UBookmarkBase, IStaticClass
	{
		...
		public TArray<FString> HiddenLevels
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __HiddenLevels, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __HiddenLevels, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.BookMark");
		}
		...
		private static uint __HiddenLevels = 0;
	}
}
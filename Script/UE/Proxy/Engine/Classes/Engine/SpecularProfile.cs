...
{
	[PathName("/Script/Engine.SpecularProfile")]
	public partial class USpecularProfile : UObject, IStaticClass
	{
		public FSpecularProfileStruct Settings
		{
			get
			{
				unsafe
				{
					...
					return *(FSpecularProfileStruct*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.SpecularProfile");
		}

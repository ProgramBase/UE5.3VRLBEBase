...
{
	[PathName("/Script/Engine.CompositeDataTable")]
	public partial class UCompositeDataTable : UDataTable, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.CompositeDataTable");
		}

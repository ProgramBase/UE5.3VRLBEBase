...
{
	[PathName("/Script/Engine.PoseWatch")]
	public partial class UPoseWatch : UObject, IStaticClass
	{
		...
		public TArray<UPoseWatchElement> Elements
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<UPoseWatchElement>*)__ReturnBuffer;
				}
			}
		...
		public bool bDeleteOnDeselection
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bDeleteOnDeselection, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bDeleteOnDeselection, __InBuffer);
				}
			}
		}
		...
		public bool bIsNodeEnabled
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bIsNodeEnabled, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bIsNodeEnabled, __InBuffer);
				}
			}
		}
		...
		public TWeakObjectPtr<UPoseWatchFolder> Parent
		{
			get
			{
				unsafe
				{
					...
					return *(TWeakObjectPtr<UPoseWatchFolder>*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.PoseWatch");
		}
		...
		private static uint __bDeleteOnDeselection = 0;

		private static uint __bIsVisible = 0;

		private static uint __bIsNodeEnabled = 0;

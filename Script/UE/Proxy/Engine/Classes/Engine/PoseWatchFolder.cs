...
{
	[PathName("/Script/Engine.PoseWatchFolder")]
	public partial class UPoseWatchFolder : UObject, IStaticClass
	{
		public FText Label
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.PoseWatchFolder");
		}

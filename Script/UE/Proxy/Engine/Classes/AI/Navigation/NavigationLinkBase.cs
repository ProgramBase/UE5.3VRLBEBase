...
{
	[PathName("/Script/Engine.NavigationLinkBase")]
	public partial class FNavigationLinkBase : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.NavigationLinkBase");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FNavigationLinkBase() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FNavigationLinkBase() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FNavigationLinkBase A, FNavigationLinkBase B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FNavigationLinkBase A, FNavigationLinkBase B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FNavigationLinkBase;
		...
		public float LeftProjectHeight
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __LeftProjectHeight, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __LeftProjectHeight, __InBuffer);
				}
			}
		}
		...
		public float MaxFallDownLength
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __MaxFallDownLength, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __MaxFallDownLength, __InBuffer);
				}
			}
		}
		...
		public float SnapRadius
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __SnapRadius, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __SnapRadius, __InBuffer);
				}
			}
		}
		...
		public float SnapHeight
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __SnapHeight, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __SnapHeight, __InBuffer);
				}
			}
		}
		...
		public FNavAgentSelector SupportedAgents
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __SupportedAgents, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __SupportedAgents, __InBuffer);
				}
			}
		}
		...
		public bool bUseSnapHeight
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bUseSnapHeight, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bUseSnapHeight, __InBuffer);
				}
			}
		}
		...
		public bool bSnapToCheapestArea
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bSnapToCheapestArea, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bSnapToCheapestArea, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag0
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag0, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag0, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag1
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag1, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag1, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag2
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag2, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag2, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag3
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag3, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag3, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag4
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag4, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag4, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag5
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag5, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag5, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag6
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag6, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag6, __InBuffer);
				}
			}
		}
		...
		public bool bCustomFlag7
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag7, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bCustomFlag7, __InBuffer);
				}
			}
		}

		public TSubclassOf<UNavAreaBase> AreaClass
		{
			get
			{
				unsafe
				{
					...
					return *(TSubclassOf<UNavAreaBase>*)__ReturnBuffer;
				}
			}
		...
		private static uint __LeftProjectHeight = 0;

		private static uint __MaxFallDownLength = 0;

		private static uint __SnapRadius = 0;

		private static uint __SnapHeight = 0;
		...
		private static uint __bUseSnapHeight = 0;

		private static uint __bSnapToCheapestArea = 0;

		private static uint __bCustomFlag0 = 0;

		private static uint __bCustomFlag1 = 0;

		private static uint __bCustomFlag2 = 0;

		private static uint __bCustomFlag3 = 0;

		private static uint __bCustomFlag4 = 0;

		private static uint __bCustomFlag5 = 0;

		private static uint __bCustomFlag6 = 0;

		private static uint __bCustomFlag7 = 0;

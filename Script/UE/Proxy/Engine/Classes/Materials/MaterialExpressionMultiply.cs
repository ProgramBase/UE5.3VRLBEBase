...
{
	[PathName("/Script/Engine.MaterialExpressionMultiply")]
	public partial class UMaterialExpressionMultiply : UMaterialExpression, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionMultiply");
		}

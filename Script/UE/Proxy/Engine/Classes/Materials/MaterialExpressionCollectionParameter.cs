...
{
	[PathName("/Script/Engine.MaterialExpressionCollectionParameter")]
	public partial class UMaterialExpressionCollectionParameter : UMaterialExpression, IStaticClass
	{
		...
		public FGuid ParameterId
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ParameterId, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ParameterId, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionCollectionParameter");
		}
		...
		private static uint __ParameterId = 0;
	}
}
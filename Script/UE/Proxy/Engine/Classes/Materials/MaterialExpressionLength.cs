...
{
	[PathName("/Script/Engine.MaterialExpressionLength")]
	public partial class UMaterialExpressionLength : UMaterialExpression, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionLength");
		}

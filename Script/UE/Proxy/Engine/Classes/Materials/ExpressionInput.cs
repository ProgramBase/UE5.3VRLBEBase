...
{
	[PathName("/Script/Engine.ExpressionInput")]
	public partial class FExpressionInput : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.ExpressionInput");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FExpressionInput() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FExpressionInput() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FExpressionInput A, FExpressionInput B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FExpressionInput A, FExpressionInput B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FExpressionInput;

...
{
	[PathName("/Script/Engine.MaterialExpressionRuntimeVirtualTextureSample")]
	public partial class UMaterialExpressionRuntimeVirtualTextureSample : UMaterialExpression, IStaticClass
	{
		...
		public bool bEnableFeedback
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bEnableFeedback, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bEnableFeedback, __InBuffer);
				}
			}
		}
		...
		public ERuntimeVirtualTextureMipValueMode MipValueMode
		{
			get
			{
				unsafe
				{
					...
					return *(ERuntimeVirtualTextureMipValueMode*)__ReturnBuffer;
				}
			}
		...
		public ERuntimeVirtualTextureTextureAddressMode TextureAddressMode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __TextureAddressMode, __ReturnBuffer);

					return *(ERuntimeVirtualTextureTextureAddressMode*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __TextureAddressMode, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionRuntimeVirtualTextureSample");
		}
		...
		private static uint __bEnableFeedback = 0;

		private static uint __MipValueMode = 0;

		private static uint __TextureAddressMode = 0;
	}
}
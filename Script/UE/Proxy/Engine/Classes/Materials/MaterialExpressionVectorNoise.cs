...
{
	[PathName("/Script/Engine.MaterialExpressionVectorNoise")]
	public partial class UMaterialExpressionVectorNoise : UMaterialExpression, IStaticClass
	{
		...
		public EVectorNoiseFunction NoiseFunction
		{
			get
			{
				unsafe
				{
					...
					return *(EVectorNoiseFunction*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionVectorNoise");
		}

...
{
	[PathName("/Script/Engine.MaterialExpressionSphereMask")]
	public partial class UMaterialExpressionSphereMask : UMaterialExpression, IStaticClass
	{
		...
		public float HardnessPercent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __HardnessPercent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __HardnessPercent, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionSphereMask");
		}
		...
		private static uint __HardnessPercent = 0;
	}
}
...
{
	[PathName("/Script/Engine.MaterialExpressionSetLocal")]
	public partial class UMaterialExpressionSetLocal : UMaterialExpression, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionSetLocal");
		}

...
{
	[PathName("/Script/Engine.MaterialExpressionFunctionOutput")]
	public partial class UMaterialExpressionFunctionOutput : UMaterialExpression, IStaticClass
	{
		...
		public bool bLastPreviewed
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bLastPreviewed, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bLastPreviewed, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionFunctionOutput");
		}
		...
		private static uint __bLastPreviewed = 0;

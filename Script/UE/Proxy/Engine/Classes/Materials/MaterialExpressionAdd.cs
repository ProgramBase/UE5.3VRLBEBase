...
{
	[PathName("/Script/Engine.MaterialExpressionAdd")]
	public partial class UMaterialExpressionAdd : UMaterialExpression, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionAdd");
		}

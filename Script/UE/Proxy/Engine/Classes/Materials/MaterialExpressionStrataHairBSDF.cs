...
{
	[PathName("/Script/Engine.MaterialExpressionStrataHairBSDF")]
	public partial class UMaterialExpressionStrataHairBSDF : UMaterialExpressionStrataBSDF, IStaticClass
	{
		...
		public FExpressionInput Scatter
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Scatter, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Scatter, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionStrataHairBSDF");
		}
		...
		private static uint __Scatter = 0;

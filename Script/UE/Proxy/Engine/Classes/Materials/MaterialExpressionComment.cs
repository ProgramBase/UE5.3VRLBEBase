...
{
	[PathName("/Script/Engine.MaterialExpressionComment")]
	public partial class UMaterialExpressionComment : UMaterialExpression, IStaticClass
	{
		public int SizeX
		{
			get
		...
		public bool bGroupMode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bGroupMode, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bGroupMode, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionComment");
		}
		...
		private static uint __bGroupMode = 0;
	}
}
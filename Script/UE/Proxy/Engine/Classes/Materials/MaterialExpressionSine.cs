...
{
	[PathName("/Script/Engine.MaterialExpressionSine")]
	public partial class UMaterialExpressionSine : UMaterialExpression, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionSine");
		}

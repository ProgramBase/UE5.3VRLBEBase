...
{
	[PathName("/Script/Engine.MaterialExpressionInverseLinearInterpolate")]
	public partial class UMaterialExpressionInverseLinearInterpolate : UMaterialExpression, IStaticClass
	{
		...
		public bool bClampResult
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bClampResult, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bClampResult, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionInverseLinearInterpolate");
		}

...
{
	[PathName("/Script/Engine.MaterialExpressionRuntimeVirtualTextureOutput")]
	public partial class UMaterialExpressionRuntimeVirtualTextureOutput : UMaterialExpressionCustomOutput, IStaticClass
	{
		...
		public FExpressionInput WorldHeight
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __WorldHeight, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __WorldHeight, __InBuffer);
				}
			}
		}
		...
		public FExpressionInput Mask
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Mask, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Mask, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionRuntimeVirtualTextureOutput");
		}
		...
		private static uint __WorldHeight = 0;

...
{
	[PathName("/Script/Engine.MaterialExpressionRotateAboutAxis")]
	public partial class UMaterialExpressionRotateAboutAxis : UMaterialExpression, IStaticClass
	{
		public FExpressionInput NormalizedRotationAxis
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __NormalizedRotationAxis, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __NormalizedRotationAxis, __InBuffer);
				}
			}
		}
		...
		public FExpressionInput PivotPoint
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PivotPoint, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PivotPoint, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionRotateAboutAxis");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __NormalizedRotationAxis = 0;

		private static uint __RotationAngle = 0;

		private static uint __PivotPoint = 0;

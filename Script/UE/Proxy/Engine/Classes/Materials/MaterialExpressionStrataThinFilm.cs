...
{
	[PathName("/Script/Engine.MaterialExpressionStrataThinFilm")]
	public partial class UMaterialExpressionStrataThinFilm : UMaterialExpressionStrataUtilityBase, IStaticClass
	{
		...
		public FExpressionInput IOR
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __IOR, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __IOR, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionStrataThinFilm");
		}

...
{
	[PathName("/Script/Engine.MaterialExpressionScalarParameter")]
	public partial class UMaterialExpressionScalarParameter : UMaterialExpressionParameter, IStaticClass
	{
		...
		public float SliderMin
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SliderMin, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SliderMin, __InBuffer);
				}
			}
		}
		...
		public float SliderMax
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SliderMax, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SliderMax, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.MaterialExpressionScalarParameter");
		}
		...
		private static uint __SliderMin = 0;

		private static uint __SliderMax = 0;
	}
}
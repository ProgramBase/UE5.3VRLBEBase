...
{
	[PathName("/Script/Engine.AnimNotifyState_TimedParticleEffect")]
	public partial class UAnimNotifyState_TimedParticleEffect : UAnimNotifyState, IStaticClass
	{
		...
		public TArray<UParticleSystem> PreviousPSTemplates
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PreviousPSTemplates, __ReturnBuffer);

					return *(TArray<UParticleSystem>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PreviousPSTemplates, __InBuffer);
				}
			}
		}
		...
		public TArray<FName> PreviousSocketNames
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PreviousSocketNames, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PreviousSocketNames, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.AnimNotifyState_TimedParticleEffect");
		}
		...
		private static uint __PreviousPSTemplates = 0;

		private static uint __PreviousSocketNames = 0;
	}
}
...
{
	[PathName("/Script/Engine.AnimNotify_PlaySound")]
	public partial class UAnimNotify_PlaySound : UAnimNotify, IStaticClass
	{
		...
		public bool bPreviewIgnoreAttenuation
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bPreviewIgnoreAttenuation, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bPreviewIgnoreAttenuation, __InBuffer);
				}
			}
		}
		...
		public FName AttachName
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __AttachName, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __AttachName, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.AnimNotify_PlaySound");
		}
		...
		private static uint __bPreviewIgnoreAttenuation = 0;

		private static uint __AttachName = 0;
	}
}
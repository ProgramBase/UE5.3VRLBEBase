...
{
	[PathName("/Script/Engine.InputScaleBiasClamp")]
	public partial class FInputScaleBiasClamp : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.InputScaleBiasClamp");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FInputScaleBiasClamp() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FInputScaleBiasClamp() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FInputScaleBiasClamp A, FInputScaleBiasClamp B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FInputScaleBiasClamp A, FInputScaleBiasClamp B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FInputScaleBiasClamp;

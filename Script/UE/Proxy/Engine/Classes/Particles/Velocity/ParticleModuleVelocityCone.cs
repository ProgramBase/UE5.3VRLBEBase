...
{
	[PathName("/Script/Engine.ParticleModuleVelocityCone")]
	public partial class UParticleModuleVelocityCone : UParticleModuleVelocityBase, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleVelocityCone");
		}

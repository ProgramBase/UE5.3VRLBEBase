...
{
	[PathName("/Script/Engine.ParticleModuleMeshRotation_Seeded")]
	public partial class UParticleModuleMeshRotation_Seeded : UParticleModuleMeshRotation, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleMeshRotation_Seeded");
		}

...
{
	[PathName("/Script/Engine.ParticleModuleAttractorPointGravity")]
	public partial class UParticleModuleAttractorPointGravity : UParticleModuleAttractorBase, IStaticClass
	{
		...
		public FRawDistributionFloat StrengthRaw
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __StrengthRaw, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __StrengthRaw, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleAttractorPointGravity");
		}
		...
		private static uint __StrengthRaw = 0;
	}
}
...
{
	[PathName("/Script/Engine.ParticleSysParam")]
	public partial class FParticleSysParam : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.ParticleSysParam");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FParticleSysParam() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FParticleSysParam() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FParticleSysParam A, FParticleSysParam B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FParticleSysParam A, FParticleSysParam B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FParticleSysParam;
		...
		public EParticleSysParamType ParamType
		{
			get
			{
				unsafe
				{
					...
					return *(EParticleSysParamType*)__ReturnBuffer;
				}
			}
		...
		public float Scalar_Low
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Scalar_Low, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Scalar_Low, __InBuffer);
				}
			}
		}
		...
		public FVector Vector_Low
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Vector_Low, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Vector_Low, __InBuffer);
				}
			}
		}
		...
		private static uint __Scalar_Low = 0;

		private static uint __Vector = 0;

		private static uint __Vector_Low = 0;

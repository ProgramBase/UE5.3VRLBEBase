...
{
	[PathName("/Script/Engine.ParticleModuleLifetime_Seeded")]
	public partial class UParticleModuleLifetime_Seeded : UParticleModuleLifetime, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleLifetime_Seeded");
		}

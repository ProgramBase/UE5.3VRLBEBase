...
{
	[PathName("/Script/Engine.ParticleModuleSize_Seeded")]
	public partial class UParticleModuleSize_Seeded : UParticleModuleSize, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleSize_Seeded");
		}

...
{
	[PathName("/Script/Engine.ParticleModuleLocationPrimitiveCylinder_Seeded")]
	public partial class UParticleModuleLocationPrimitiveCylinder_Seeded : UParticleModuleLocationPrimitiveCylinder, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleLocationPrimitiveCylinder_Seeded");
		}

...
{
	[PathName("/Script/Engine.ParticleModuleLocationWorldOffset_Seeded")]
	public partial class UParticleModuleLocationWorldOffset_Seeded : UParticleModuleLocationWorldOffset, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ParticleModuleLocationWorldOffset_Seeded");
		}

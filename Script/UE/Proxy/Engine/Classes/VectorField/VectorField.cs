...
{
	[PathName("/Script/Engine.VectorField")]
	public partial class UVectorField : UObject, IStaticClass
	{
		public FBox Bounds
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.VectorField");
		}

...
{
	[PathName("/Script/Engine.VectorFieldStatic")]
	public partial class UVectorFieldStatic : UVectorField, IStaticClass
	{
		public int SizeX
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.VectorFieldStatic");
		}

...
{
	[PathName("/Script/Engine.VirtualTexture2D")]
	public partial class UVirtualTexture2D : UTexture2D, IStaticClass
	{
		public FVirtualTextureBuildSettings Settings
		{
			get
			{
				unsafe
				{
					...
					return *(FVirtualTextureBuildSettings*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.VirtualTexture2D");
		}

...
{
	[PathName("/Script/Engine.GameSession")]
	public partial class AGameSession : AInfo, IStaticClass
	{
		...
		public int MaxPartySize
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MaxPartySize, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MaxPartySize, __InBuffer);
				}
			}
		}
		...
		public byte MaxSplitscreensPerConnection
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MaxSplitscreensPerConnection, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MaxSplitscreensPerConnection, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.GameSession");
		}
		...
		private static uint __MaxSplitscreensPerConnection = 0;

...
{
	[PathName("/Script/Engine.ReflectionCaptureComponent")]
	public partial class UReflectionCaptureComponent : USceneComponent, IStaticClass
	{
		public UBillboardComponent CaptureOffsetComponent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CaptureOffsetComponent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CaptureOffsetComponent, __InBuffer);
				}
			}
		}
		...
		public EReflectionSourceType ReflectionSourceType
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ReflectionSourceType, __ReturnBuffer);

					return *(EReflectionSourceType*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ReflectionSourceType, __InBuffer);
				}
			}
		}
		...
		public FVector CaptureOffset
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CaptureOffset, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CaptureOffset, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ReflectionCaptureComponent");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __CaptureOffsetComponent = 0;

		private static uint __ReflectionSourceType = 0;
		...
		private static uint __CaptureOffset = 0;

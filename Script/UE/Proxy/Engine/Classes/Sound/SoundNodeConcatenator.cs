...
{
	[PathName("/Script/Engine.SoundNodeConcatenator")]
	public partial class USoundNodeConcatenator : USoundNode, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.SoundNodeConcatenator");
		}

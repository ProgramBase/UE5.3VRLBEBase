...
{
	[PathName("/Script/Engine.SoundCue")]
	public partial class USoundCue : USoundBase, IStaticClass
	{
		public USoundNode FirstNode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __FirstNode, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __FirstNode, __InBuffer);
				}
			}
		}
		...
		public UEdGraph SoundCueGraph
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SoundCueGraph, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SoundCueGraph, __InBuffer);
				}
			}
		}
		...
		public bool bPrimeOnLoad
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bPrimeOnLoad, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bPrimeOnLoad, __InBuffer);
				}
			}
		}
		...
		public bool bExcludeFromRandomNodeBranchCulling
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bExcludeFromRandomNodeBranchCulling, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bExcludeFromRandomNodeBranchCulling, __InBuffer);
				}
			}
		}
		...
		public bool bHasPlayWhenSilent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bHasPlayWhenSilent, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bHasPlayWhenSilent, __InBuffer);
				}
			}
		}
		...
		public int CookedQualityIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CookedQualityIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CookedQualityIndex, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.SoundCue");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __FirstNode = 0;
		...
		private static uint __SoundCueGraph = 0;

		private static uint __SubtitlePriority = 0;

		private static uint __bPrimeOnLoad = 0;

		private static uint __bOverrideAttenuation = 0;

		private static uint __bExcludeFromRandomNodeBranchCulling = 0;

		private static uint __bHasPlayWhenSilent = 0;

		private static uint __CookedQualityIndex = 0;
	}
}
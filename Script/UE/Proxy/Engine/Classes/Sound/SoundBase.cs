...
{
	[PathName("/Script/Engine.SoundBase")]
	public partial class USoundBase : UObject, IStaticClass, IInterface_AssetUserData
	{
		public USoundClass SoundClassObject
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SoundClassObject, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SoundClassObject, __InBuffer);
				}
			}
		}
		...
		public bool bHasDelayNode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bHasDelayNode, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bHasDelayNode, __InBuffer);
				}
			}
		}
		...
		public bool bHasConcatenatorNode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bHasConcatenatorNode, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bHasConcatenatorNode, __InBuffer);
				}
			}
		}
		...
		public bool bBypassVolumeScaleForPriority
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bBypassVolumeScaleForPriority, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bBypassVolumeScaleForPriority, __InBuffer);
				}
			}
		}
		...
		public EVirtualizationMode VirtualizationMode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __VirtualizationMode, __ReturnBuffer);

					return *(EVirtualizationMode*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __VirtualizationMode, __InBuffer);
				}
			}
		}
		...
		public FSoundConcurrencySettings ConcurrencyOverrides
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ConcurrencyOverrides, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ConcurrencyOverrides, __InBuffer);
				}
			}
		}
		...
		public float TotalSamples
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __TotalSamples, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __TotalSamples, __InBuffer);
				}
			}
		}
		...
		public USoundSubmixBase SoundSubmixObject
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SoundSubmixObject, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SoundSubmixObject, __InBuffer);
				}
			}
		}
		...
		public FSoundTimecodeOffset TimecodeOffset
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __TimecodeOffset, __ReturnBuffer);

					return *(FSoundTimecodeOffset*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __TimecodeOffset, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.SoundBase");
		}
		...
		public virtual bool IsAttenuationSettingsEditable()
		{
			unsafe
			{
				var __ReturnBuffer = stackalloc byte[1];

				FFunctionImplementation.FFunction_PrimitiveCall9Implementation(GarbageCollectionHandle, __IsAttenuationSettingsEditable, __ReturnBuffer);
		...
		private static uint __bHasDelayNode = 0;

		private static uint __bHasConcatenatorNode = 0;

		private static uint __bBypassVolumeScaleForPriority = 0;

		private static uint __VirtualizationMode = 0;

		private static uint __ConcurrencySet = 0;

		private static uint __ConcurrencyOverrides = 0;

		private static uint __Duration = 0;

		private static uint __MaxDistance = 0;

		private static uint __TotalSamples = 0;

		private static uint __Priority = 0;

		private static uint __AttenuationSettings = 0;

		private static uint __SoundSubmixObject = 0;
		...
		private static uint __TimecodeOffset = 0;

		private static uint __ExecuteUbergraph = 0;

		private static uint __IsAttenuationSettingsEditable = 0;
	}
}
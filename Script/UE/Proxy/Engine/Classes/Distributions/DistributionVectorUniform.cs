...
{
	[PathName("/Script/Engine.DistributionVectorUniform")]
	public partial class UDistributionVectorUniform : UDistributionVector, IStaticClass
	{
		public FVector Max
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.DistributionVectorUniform");
		}

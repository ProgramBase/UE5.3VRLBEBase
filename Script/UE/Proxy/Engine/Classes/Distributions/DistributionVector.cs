...
{
	[PathName("/Script/Engine.DistributionVector")]
	public partial class UDistributionVector : UDistribution, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.DistributionVector");
		}

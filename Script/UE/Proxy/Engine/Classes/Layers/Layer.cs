...
{
	[PathName("/Script/Engine.Layer")]
	public partial class ULayer : UObject, IStaticClass
	{
		...
		public TArray<FLayerActorStats> ActorStats
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ActorStats, __ReturnBuffer);

					return *(TArray<FLayerActorStats>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ActorStats, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.Layer");
		}
		...
		private static uint __ActorStats = 0;
	}
}
...
{
	[PathName("/Script/Engine.AlphaBlendArgs")]
	public partial class FAlphaBlendArgs : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.AlphaBlendArgs");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FAlphaBlendArgs() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FAlphaBlendArgs() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FAlphaBlendArgs A, FAlphaBlendArgs B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FAlphaBlendArgs A, FAlphaBlendArgs B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FAlphaBlendArgs;

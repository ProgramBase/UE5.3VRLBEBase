...
{
	[PathName("/Script/Engine.DeprecatedDataLayerInstance")]
	public partial class UDeprecatedDataLayerInstance : UDataLayerInstance, IStaticClass
	{
		public FName Label
		{
			get
		...
		public FName DeprecatedDataLayerFName
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __DeprecatedDataLayerFName, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __DeprecatedDataLayerFName, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.DeprecatedDataLayerInstance");
		}
		...
		private static uint __DeprecatedDataLayerFName = 0;

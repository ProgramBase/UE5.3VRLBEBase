...
{
	[PathName("/Script/Engine.SpatialHashStreamingGrid")]
	public partial class FSpatialHashStreamingGrid : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.SpatialHashStreamingGrid");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FSpatialHashStreamingGrid() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FSpatialHashStreamingGrid() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FSpatialHashStreamingGrid A, FSpatialHashStreamingGrid B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FSpatialHashStreamingGrid A, FSpatialHashStreamingGrid B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FSpatialHashStreamingGrid;
		...
		public TArray<FSpatialHashStreamingGridLevel> GridLevels
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __GridLevels, __ReturnBuffer);

					return *(TArray<FSpatialHashStreamingGridLevel>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __GridLevels, __InBuffer);
				}
			}
		}
		...
		public FBox WorldBounds
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __WorldBounds, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __WorldBounds, __InBuffer);
				}
			}
		}
		...
		private static uint __GridLevels = 0;

		private static uint __WorldBounds = 0;

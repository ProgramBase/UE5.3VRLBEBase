...
{
	[PathName("/Script/Engine.ContentBundleDescriptor")]
	public partial class UContentBundleDescriptor : UObject, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.ContentBundleDescriptor");
		}

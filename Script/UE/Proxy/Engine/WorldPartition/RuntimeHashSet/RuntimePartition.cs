...
{
	[PathName("/Script/Engine.RuntimePartition")]
	public partial class URuntimePartition : UObject, IStaticClass
	{
		public FName Name
		{
			get
		...
		public bool bBlockOnSlowStreaming
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bBlockOnSlowStreaming, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bBlockOnSlowStreaming, __InBuffer);
				}
			}
		}
		...
		public bool bIsHLODSetup
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bIsHLODSetup, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bIsHLODSetup, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.RuntimePartition");
		}
		...
		private static uint __bIsHLODSetup = 0;
	}
}
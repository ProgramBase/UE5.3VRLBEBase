...
{
	[PathName("/Script/Engine.HLODProxyDesc")]
	public partial class UHLODProxyDesc : UObject, IStaticClass
	{
		...
		public TArray<FHLODISMComponentDesc> ISMComponentsDesc
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ISMComponentsDesc, __ReturnBuffer);

					return *(TArray<FHLODISMComponentDesc>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ISMComponentsDesc, __InBuffer);
				}
			}
		}
		...
		public TArray<TSoftObjectPtr<UHLODProxyDesc>> SubHLODDescs
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SubHLODDescs, __ReturnBuffer);

					return *(TArray<TSoftObjectPtr<UHLODProxyDesc>>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SubHLODDescs, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Engine.HLODProxyDesc");
		}
		...
		private static uint __ISMComponentsDesc = 0;
		...
		private static uint __SubHLODDescs = 0;
	}
}
...
{
	[PathName("/Script/Engine.StaticComponentMaskParameter")]
	public partial class FStaticComponentMaskParameter : FStaticParameterBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Engine.StaticComponentMaskParameter");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FStaticComponentMaskParameter()
		{
		}

		public static bool operator ==(FStaticComponentMaskParameter A, FStaticComponentMaskParameter B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FStaticComponentMaskParameter A, FStaticComponentMaskParameter B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FStaticComponentMaskParameter;

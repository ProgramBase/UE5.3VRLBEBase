...
{
	[PathName("/Script/TemplateSequence.SequenceCameraShakePattern")]
	public partial class USequenceCameraShakePattern : UCameraShakePattern, IStaticClass
	{
		...
		public float RandomSegmentDuration
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __RandomSegmentDuration, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __RandomSegmentDuration, __InBuffer);
				}
			}
		}
		...
		public bool bRandomSegment
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bRandomSegment, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bRandomSegment, __InBuffer);
				}
			}
		}
		...
		public UCameraAnimationSequenceCameraStandIn CameraStandIn
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CameraStandIn, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CameraStandIn, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/TemplateSequence.SequenceCameraShakePattern");
		}
		...
		private static uint __RandomSegmentDuration = 0;

		private static uint __bRandomSegment = 0;

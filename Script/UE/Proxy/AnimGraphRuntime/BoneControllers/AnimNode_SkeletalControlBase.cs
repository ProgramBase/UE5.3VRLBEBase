...
{
	[PathName("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase")]
	public partial class FAnimNode_SkeletalControlBase : FAnimNode_Base, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/AnimGraphRuntime.AnimNode_SkeletalControlBase");
		}
		...
		public static bool operator ==(FAnimNode_SkeletalControlBase A, FAnimNode_SkeletalControlBase B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FAnimNode_SkeletalControlBase A, FAnimNode_SkeletalControlBase B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FAnimNode_SkeletalControlBase;
		...
		public FText ValidationVisualWarningMessage
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __ValidationVisualWarningMessage, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __ValidationVisualWarningMessage, __InBuffer);
				}
			}
		}
		...
		private static uint __ValidationVisualWarningMessage = 0;

...
{
	[PathName("/Script/AnimGraphRuntime.AnimNode_Mirror_Standalone")]
	public partial class FAnimNode_Mirror_Standalone : FAnimNode_MirrorBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/AnimGraphRuntime.AnimNode_Mirror_Standalone");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FAnimNode_Mirror_Standalone()
		{
		}

		public static bool operator ==(FAnimNode_Mirror_Standalone A, FAnimNode_Mirror_Standalone B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FAnimNode_Mirror_Standalone A, FAnimNode_Mirror_Standalone B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FAnimNode_Mirror_Standalone;

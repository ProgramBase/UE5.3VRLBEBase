...
{
	[PathName("/Script/AnimGraphRuntime.AnimNode_BlendSpacePlayer")]
	public partial class FAnimNode_BlendSpacePlayer : FAnimNode_BlendSpacePlayerBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/AnimGraphRuntime.AnimNode_BlendSpacePlayer");
		}
		...
		public static bool operator ==(FAnimNode_BlendSpacePlayer A, FAnimNode_BlendSpacePlayer B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FAnimNode_BlendSpacePlayer A, FAnimNode_BlendSpacePlayer B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FAnimNode_BlendSpacePlayer;

...
{
	[PathName("/Script/AnimGraphRuntime.RotationRetargetingInfo")]
	public partial class FRotationRetargetingInfo : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/AnimGraphRuntime.RotationRetargetingInfo");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRotationRetargetingInfo() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FRotationRetargetingInfo() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FRotationRetargetingInfo A, FRotationRetargetingInfo B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRotationRetargetingInfo A, FRotationRetargetingInfo B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRotationRetargetingInfo;
		...
		public ERotationComponent RotationComponent
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __RotationComponent, __ReturnBuffer);

					return *(ERotationComponent*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __RotationComponent, __InBuffer);
				}
			}
		}
		...
		public bool bUseAbsoluteAngle
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bUseAbsoluteAngle, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bUseAbsoluteAngle, __InBuffer);
				}
			}
		}
		...
		public EEasingFuncType EasingType
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __EasingType, __ReturnBuffer);

					return *(EEasingFuncType*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __EasingType, __InBuffer);
				}
			}
		}
		...
		public bool bFlipEasing
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bFlipEasing, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bFlipEasing, __InBuffer);
				}
			}
		}
		...
		public float EasingWeight
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __EasingWeight, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __EasingWeight, __InBuffer);
				}
			}
		}
		...
		private static uint __RotationComponent = 0;

		private static uint __TwistAxis = 0;

		private static uint __bUseAbsoluteAngle = 0;
		...
		private static uint __EasingType = 0;

		private static uint __CustomCurve = 0;

		private static uint __bFlipEasing = 0;

		private static uint __EasingWeight = 0;

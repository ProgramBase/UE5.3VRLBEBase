...
{
	[PathName("/Script/AIGraph.AIGraphNode")]
	public partial class UAIGraphNode : UEdGraphNode, IStaticClass
	{
		...
		public UAIGraphNode ParentNode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __ParentNode, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __ParentNode, __InBuffer);
				}
			}
		}
		...
		public TArray<UAIGraphNode> SubNodes
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SubNodes, __ReturnBuffer);

					return *(TArray<UAIGraphNode>*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SubNodes, __InBuffer);
				}
			}
		}
		...
		public int CopySubNodeIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CopySubNodeIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CopySubNodeIndex, __InBuffer);
				}
			}
		}
		...
		public bool bIsSubNode
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bIsSubNode, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bIsSubNode, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AIGraph.AIGraphNode");
		}
		...
		private static uint __SubNodes = 0;

		private static uint __CopySubNodeIndex = 0;

		private static uint __bIsReadOnly = 0;

		private static uint __bIsSubNode = 0;

...
{
	[PathName("/Script/Paper2D.PaperFlipbookActor")]
	public partial class APaperFlipbookActor : AActor, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Paper2D.PaperFlipbookActor");
		}

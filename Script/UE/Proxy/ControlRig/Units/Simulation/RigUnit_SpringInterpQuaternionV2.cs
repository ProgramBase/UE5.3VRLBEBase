...
{
	[PathName("/Script/ControlRig.RigUnit_SpringInterpQuaternionV2")]
	public partial class FRigUnit_SpringInterpQuaternionV2 : FRigVMFunction_SimBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SpringInterpQuaternionV2");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SpringInterpQuaternionV2()
		{
		}

		public static bool operator ==(FRigUnit_SpringInterpQuaternionV2 A, FRigUnit_SpringInterpQuaternionV2 B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SpringInterpQuaternionV2 A, FRigUnit_SpringInterpQuaternionV2 B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SpringInterpQuaternionV2;
		...
		public FVector Torque
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __Torque, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __Torque, __InBuffer);
				}
			}
		}
		...
		public FQuaternionSpringState SpringState
		{
			get
			{
				unsafe
				{
					...
					return *(FQuaternionSpringState*)__ReturnBuffer;
				}
			}
		...
		private static uint __Torque = 0;

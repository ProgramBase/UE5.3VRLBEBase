...
{
	[PathName("/Script/ControlRig.RigUnit_SpringInterpV2")]
	public partial class FRigUnit_SpringInterpV2 : FRigVMFunction_SimBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SpringInterpV2");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SpringInterpV2()
		{
		}

		public static bool operator ==(FRigUnit_SpringInterpV2 A, FRigUnit_SpringInterpV2 B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SpringInterpV2 A, FRigUnit_SpringInterpV2 B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SpringInterpV2;

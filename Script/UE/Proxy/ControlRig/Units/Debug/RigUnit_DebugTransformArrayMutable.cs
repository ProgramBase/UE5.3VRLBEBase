...
{
	[PathName("/Script/ControlRig.RigUnit_DebugTransformArrayMutable")]
	public partial class FRigUnit_DebugTransformArrayMutable : FRigUnit_DebugBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_DebugTransformArrayMutable");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_DebugTransformArrayMutable()
		{
		}

		public static bool operator ==(FRigUnit_DebugTransformArrayMutable A, FRigUnit_DebugTransformArrayMutable B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_DebugTransformArrayMutable A, FRigUnit_DebugTransformArrayMutable B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_DebugTransformArrayMutable;
		...
		public ERigUnitDebugTransformMode Mode
		{
			get
			{
				unsafe
				{
					...
					return *(ERigUnitDebugTransformMode*)__ReturnBuffer;
				}
			}
		...
		public FRigUnit_DebugTransformArrayMutable_WorkData WorkData
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_DebugTransformArrayMutable_WorkData*)__ReturnBuffer;
				}
			}

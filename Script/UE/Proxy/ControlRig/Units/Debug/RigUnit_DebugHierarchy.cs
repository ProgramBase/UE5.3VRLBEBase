...
{
	[PathName("/Script/ControlRig.RigUnit_DebugHierarchy")]
	public partial class FRigUnit_DebugHierarchy : FRigVMFunction_DebugBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_DebugHierarchy");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_DebugHierarchy()
		{
		}

		public static bool operator ==(FRigUnit_DebugHierarchy A, FRigUnit_DebugHierarchy B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_DebugHierarchy A, FRigUnit_DebugHierarchy B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_DebugHierarchy;

...
{
	[PathName("/Script/ControlRig.RigUnit_DebugArc")]
	public partial class FRigUnit_DebugArc : FRigUnit_DebugBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_DebugArc");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_DebugArc()
		{
		}

		public static bool operator ==(FRigUnit_DebugArc A, FRigUnit_DebugArc B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_DebugArc A, FRigUnit_DebugArc B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_DebugArc;

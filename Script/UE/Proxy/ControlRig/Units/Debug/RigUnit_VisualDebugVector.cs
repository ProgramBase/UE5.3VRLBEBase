...
{
	[PathName("/Script/ControlRig.RigUnit_VisualDebugVector")]
	public partial class FRigUnit_VisualDebugVector : FRigUnit_DebugBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_VisualDebugVector");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_VisualDebugVector()
		{
		}

		public static bool operator ==(FRigUnit_VisualDebugVector A, FRigUnit_VisualDebugVector B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_VisualDebugVector A, FRigUnit_VisualDebugVector B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_VisualDebugVector;

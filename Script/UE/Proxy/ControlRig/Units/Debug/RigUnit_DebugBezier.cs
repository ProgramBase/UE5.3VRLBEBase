...
{
	[PathName("/Script/ControlRig.RigUnit_DebugBezier")]
	public partial class FRigUnit_DebugBezier : FRigVMFunction_DebugBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_DebugBezier");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_DebugBezier()
		{
		}

		public static bool operator ==(FRigUnit_DebugBezier A, FRigUnit_DebugBezier B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_DebugBezier A, FRigUnit_DebugBezier B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_DebugBezier;
		...
		public float MinimumU
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __MinimumU, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __MinimumU, __InBuffer);
				}
			}
		}
		...
		public float MaximumU
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __MaximumU, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __MaximumU, __InBuffer);
				}
			}
		}
		...
		private static uint __MinimumU = 0;

		private static uint __MaximumU = 0;

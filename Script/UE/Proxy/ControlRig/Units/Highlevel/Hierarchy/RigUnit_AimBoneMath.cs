...
{
	[PathName("/Script/ControlRig.RigUnit_AimBoneMath")]
	public partial class FRigUnit_AimBoneMath : FRigUnit_HighlevelBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_AimBoneMath");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_AimBoneMath()
		{
		}

		public static bool operator ==(FRigUnit_AimBoneMath A, FRigUnit_AimBoneMath B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_AimBoneMath A, FRigUnit_AimBoneMath B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_AimBoneMath;
		...
		public FTransform InputTransform
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __InputTransform, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __InputTransform, __InBuffer);
				}
			}
		}
		...
		private static uint __InputTransform = 0;

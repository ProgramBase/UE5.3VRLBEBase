...
{
	[PathName("/Script/ControlRig.RigUnit_TwoBoneIKSimple")]
	public partial class FRigUnit_TwoBoneIKSimple : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_TwoBoneIKSimple");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_TwoBoneIKSimple()
		{
		}

		public static bool operator ==(FRigUnit_TwoBoneIKSimple A, FRigUnit_TwoBoneIKSimple B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_TwoBoneIKSimple A, FRigUnit_TwoBoneIKSimple B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_TwoBoneIKSimple;
		...
		public FName BoneA
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __BoneA, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __BoneA, __InBuffer);
				}
			}
		}
		...
		public FName BoneB
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __BoneB, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __BoneB, __InBuffer);
				}
			}
		}
		...
		public FCachedRigElement CachedBoneAIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __CachedBoneAIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __CachedBoneAIndex, __InBuffer);
				}
			}
		}
		...
		public FCachedRigElement CachedBoneBIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __CachedBoneBIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __CachedBoneBIndex, __InBuffer);
				}
			}
		}
		...
		public FCachedRigElement CachedEffectorBoneIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __CachedEffectorBoneIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __CachedEffectorBoneIndex, __InBuffer);
				}
			}
		}
		...
		private static uint __BoneA = 0;

		private static uint __BoneB = 0;
		...
		private static uint __CachedBoneAIndex = 0;

		private static uint __CachedBoneBIndex = 0;

		private static uint __CachedEffectorBoneIndex = 0;

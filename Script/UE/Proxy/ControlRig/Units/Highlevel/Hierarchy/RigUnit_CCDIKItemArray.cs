...
{
	[PathName("/Script/ControlRig.RigUnit_CCDIKItemArray")]
	public partial class FRigUnit_CCDIKItemArray : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_CCDIKItemArray");
		}
		...
		public static bool operator ==(FRigUnit_CCDIKItemArray A, FRigUnit_CCDIKItemArray B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_CCDIKItemArray A, FRigUnit_CCDIKItemArray B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_CCDIKItemArray;
		...
		public TArray<FRigUnit_CCDIK_RotationLimitPerItem> RotationLimits
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<FRigUnit_CCDIK_RotationLimitPerItem>*)__ReturnBuffer;
				}
			}

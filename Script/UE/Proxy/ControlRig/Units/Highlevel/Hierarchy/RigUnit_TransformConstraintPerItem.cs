...
{
	[PathName("/Script/ControlRig.RigUnit_TransformConstraintPerItem")]
	public partial class FRigUnit_TransformConstraintPerItem : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_TransformConstraintPerItem");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_TransformConstraintPerItem()
		{
		}

		public static bool operator ==(FRigUnit_TransformConstraintPerItem A, FRigUnit_TransformConstraintPerItem B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_TransformConstraintPerItem A, FRigUnit_TransformConstraintPerItem B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_TransformConstraintPerItem;
		...
		public FRigElementKey BaseItem
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __BaseItem, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __BaseItem, __InBuffer);
				}
			}
		}
		...
		private static uint __BaseItem = 0;

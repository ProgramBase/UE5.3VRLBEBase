...
{
	[PathName("/Script/ControlRig.RigUnit_AimItem_Target")]
	public partial class FRigUnit_AimItem_Target : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_AimItem_Target");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_AimItem_Target() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FRigUnit_AimItem_Target() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FRigUnit_AimItem_Target A, FRigUnit_AimItem_Target B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_AimItem_Target A, FRigUnit_AimItem_Target B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_AimItem_Target;

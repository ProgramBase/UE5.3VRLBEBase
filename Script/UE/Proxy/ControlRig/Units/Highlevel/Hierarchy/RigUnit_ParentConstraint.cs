...
{
	[PathName("/Script/ControlRig.RigUnit_ParentConstraint")]
	public partial class FRigUnit_ParentConstraint : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_ParentConstraint");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_ParentConstraint()
		{
		}

		public static bool operator ==(FRigUnit_ParentConstraint A, FRigUnit_ParentConstraint B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_ParentConstraint A, FRigUnit_ParentConstraint B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_ParentConstraint;
		...
		public FRigUnit_ParentConstraint_AdvancedSettings AdvancedSettings
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_ParentConstraint_AdvancedSettings*)__ReturnBuffer;
				}
			}

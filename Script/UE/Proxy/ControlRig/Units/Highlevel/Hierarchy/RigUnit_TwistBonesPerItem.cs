...
{
	[PathName("/Script/ControlRig.RigUnit_TwistBonesPerItem")]
	public partial class FRigUnit_TwistBonesPerItem : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_TwistBonesPerItem");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_TwistBonesPerItem()
		{
		}

		public static bool operator ==(FRigUnit_TwistBonesPerItem A, FRigUnit_TwistBonesPerItem B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_TwistBonesPerItem A, FRigUnit_TwistBonesPerItem B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_TwistBonesPerItem;
		...
		public FVector PoleAxis
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __PoleAxis, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __PoleAxis, __InBuffer);
				}
			}
		}
		...
		public ERigVMAnimEasingType TwistEaseType
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __TwistEaseType, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __TwistEaseType, __InBuffer);
				}
			}
		}
		...
		public FRigUnit_TwistBones_WorkData WorkData
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_TwistBones_WorkData*)__ReturnBuffer;
				}
			}
		...
		private static uint __PoleAxis = 0;

		private static uint __TwistEaseType = 0;

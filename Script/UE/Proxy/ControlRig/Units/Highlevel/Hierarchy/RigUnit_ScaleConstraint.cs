...
{
	[PathName("/Script/ControlRig.RigUnit_ScaleConstraint")]
	public partial class FRigUnit_ScaleConstraint : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_ScaleConstraint");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_ScaleConstraint()
		{
		}

		public static bool operator ==(FRigUnit_ScaleConstraint A, FRigUnit_ScaleConstraint B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_ScaleConstraint A, FRigUnit_ScaleConstraint B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_ScaleConstraint;

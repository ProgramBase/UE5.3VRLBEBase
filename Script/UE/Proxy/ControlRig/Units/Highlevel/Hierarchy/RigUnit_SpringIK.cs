...
{
	[PathName("/Script/ControlRig.RigUnit_SpringIK")]
	public partial class FRigUnit_SpringIK : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SpringIK");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SpringIK()
		{
		}

		public static bool operator ==(FRigUnit_SpringIK A, FRigUnit_SpringIK B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SpringIK A, FRigUnit_SpringIK B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SpringIK;
		...
		public float HierarchyStrength
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __HierarchyStrength, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __HierarchyStrength, __InBuffer);
				}
			}
		}
		...
		public float EffectorStrength
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __EffectorStrength, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __EffectorStrength, __InBuffer);
				}
			}
		}
		...
		public float EffectorRatio
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __EffectorRatio, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __EffectorRatio, __InBuffer);
				}
			}
		}
		...
		public float RootStrength
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __RootStrength, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __RootStrength, __InBuffer);
				}
			}
		}
		...
		public float RootRatio
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __RootRatio, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __RootRatio, __InBuffer);
				}
			}
		}
		...
		public bool bFlipPolePlane
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bFlipPolePlane, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bFlipPolePlane, __InBuffer);
				}
			}
		}
		...
		public bool bLiveSimulation
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bLiveSimulation, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bLiveSimulation, __InBuffer);
				}
			}
		}
		...
		public FRigUnit_SpringIK_DebugSettings DebugSettings
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_SpringIK_DebugSettings*)__ReturnBuffer;
				}
			}
		...
		public FRigUnit_SpringIK_WorkData WorkData
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_SpringIK_WorkData*)__ReturnBuffer;
				}
			}
		...
		private static uint __HierarchyStrength = 0;

		private static uint __EffectorStrength = 0;

		private static uint __EffectorRatio = 0;

		private static uint __RootStrength = 0;

		private static uint __RootRatio = 0;

		private static uint __Damping = 0;

		private static uint __PoleVector = 0;

		private static uint __bFlipPolePlane = 0;
		...
		private static uint __bLiveSimulation = 0;

...
{
	[PathName("/Script/ControlRig.RigUnit_BoneHarmonics")]
	public partial class FRigUnit_BoneHarmonics : FRigUnit_HighlevelBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_BoneHarmonics");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_BoneHarmonics()
		{
		}

		public static bool operator ==(FRigUnit_BoneHarmonics A, FRigUnit_BoneHarmonics B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_BoneHarmonics A, FRigUnit_BoneHarmonics B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_BoneHarmonics;
		...
		public TArray<FRigUnit_BoneHarmonics_BoneTarget> Bones
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<FRigUnit_BoneHarmonics_BoneTarget>*)__ReturnBuffer;
				}
			}
		...
		public FVector WaveSpeed
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __WaveSpeed, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __WaveSpeed, __InBuffer);
				}
			}
		}
		...
		public FRigUnit_BoneHarmonics_WorkData WorkData
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_BoneHarmonics_WorkData*)__ReturnBuffer;
				}
			}
		...
		private static uint __WaveSpeed = 0;

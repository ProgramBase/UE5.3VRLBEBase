...
{
	[PathName("/Script/ControlRig.RigUnit_SetBoneTransform")]
	public partial class FRigUnit_SetBoneTransform : FRigUnitMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SetBoneTransform");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SetBoneTransform()
		{
		}

		public static bool operator ==(FRigUnit_SetBoneTransform A, FRigUnit_SetBoneTransform B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SetBoneTransform A, FRigUnit_SetBoneTransform B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SetBoneTransform;

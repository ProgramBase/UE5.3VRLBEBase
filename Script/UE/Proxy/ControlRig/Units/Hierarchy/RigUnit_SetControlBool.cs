...
{
	[PathName("/Script/ControlRig.RigUnit_SetControlBool")]
	public partial class FRigUnit_SetControlBool : FRigUnitMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SetControlBool");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SetControlBool()
		{
		}

		public static bool operator ==(FRigUnit_SetControlBool A, FRigUnit_SetControlBool B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SetControlBool A, FRigUnit_SetControlBool B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SetControlBool;

...
{
	[PathName("/Script/ControlRig.RigUnit_GetBoneTransform")]
	public partial class FRigUnit_GetBoneTransform : FRigUnit, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_GetBoneTransform");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_GetBoneTransform()
		{
		}

		public static bool operator ==(FRigUnit_GetBoneTransform A, FRigUnit_GetBoneTransform B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_GetBoneTransform A, FRigUnit_GetBoneTransform B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_GetBoneTransform;
		...
		public bool bFirstUpdate
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bFirstUpdate, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bFirstUpdate, __InBuffer);
				}
			}
		}
		...
		private static uint __bFirstUpdate = 0;

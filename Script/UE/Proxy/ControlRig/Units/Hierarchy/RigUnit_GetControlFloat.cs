...
{
	[PathName("/Script/ControlRig.RigUnit_GetControlFloat")]
	public partial class FRigUnit_GetControlFloat : FRigUnit, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_GetControlFloat");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_GetControlFloat()
		{
		}

		public static bool operator ==(FRigUnit_GetControlFloat A, FRigUnit_GetControlFloat B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_GetControlFloat A, FRigUnit_GetControlFloat B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_GetControlFloat;

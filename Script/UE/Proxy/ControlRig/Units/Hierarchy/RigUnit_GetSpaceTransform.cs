...
{
	[PathName("/Script/ControlRig.RigUnit_GetSpaceTransform")]
	public partial class FRigUnit_GetSpaceTransform : FRigUnit, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_GetSpaceTransform");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_GetSpaceTransform()
		{
		}

		public static bool operator ==(FRigUnit_GetSpaceTransform A, FRigUnit_GetSpaceTransform B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_GetSpaceTransform A, FRigUnit_GetSpaceTransform B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_GetSpaceTransform;

...
{
	[PathName("/Script/ControlRig.RigUnit_SetTranslation")]
	public partial class FRigUnit_SetTranslation : FRigUnitMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SetTranslation");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SetTranslation()
		{
		}

		public static bool operator ==(FRigUnit_SetTranslation A, FRigUnit_SetTranslation B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SetTranslation A, FRigUnit_SetTranslation B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SetTranslation;

...
{
	[PathName("/Script/ControlRig.RigUnit_RemoveMetadataTag")]
	public partial class FRigUnit_RemoveMetadataTag : FRigUnitMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_RemoveMetadataTag");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_RemoveMetadataTag()
		{
		}

		public static bool operator ==(FRigUnit_RemoveMetadataTag A, FRigUnit_RemoveMetadataTag B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_RemoveMetadataTag A, FRigUnit_RemoveMetadataTag B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_RemoveMetadataTag;

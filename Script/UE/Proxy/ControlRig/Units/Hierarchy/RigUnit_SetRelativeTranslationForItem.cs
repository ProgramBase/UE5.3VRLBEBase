...
{
	[PathName("/Script/ControlRig.RigUnit_SetRelativeTranslationForItem")]
	public partial class FRigUnit_SetRelativeTranslationForItem : FRigUnitMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_SetRelativeTranslationForItem");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_SetRelativeTranslationForItem()
		{
		}

		public static bool operator ==(FRigUnit_SetRelativeTranslationForItem A, FRigUnit_SetRelativeTranslationForItem B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_SetRelativeTranslationForItem A, FRigUnit_SetRelativeTranslationForItem B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_SetRelativeTranslationForItem;
		...
		public bool bParentInitial
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __bParentInitial, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __bParentInitial, __InBuffer);
				}
			}
		}
		...
		private static uint __bParentInitial = 0;

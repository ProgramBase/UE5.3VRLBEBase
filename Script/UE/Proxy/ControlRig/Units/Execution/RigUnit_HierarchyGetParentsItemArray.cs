...
{
	[PathName("/Script/ControlRig.RigUnit_HierarchyGetParentsItemArray")]
	public partial class FRigUnit_HierarchyGetParentsItemArray : FRigUnit_HierarchyBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_HierarchyGetParentsItemArray");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_HierarchyGetParentsItemArray()
		{
		}

		public static bool operator ==(FRigUnit_HierarchyGetParentsItemArray A, FRigUnit_HierarchyGetParentsItemArray B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_HierarchyGetParentsItemArray A, FRigUnit_HierarchyGetParentsItemArray B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_HierarchyGetParentsItemArray;

...
{
	[PathName("/Script/ControlRig.RigUnit_HierarchySetPoseItemArray")]
	public partial class FRigUnit_HierarchySetPoseItemArray : FRigUnit_HierarchyBaseMutable, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_HierarchySetPoseItemArray");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_HierarchySetPoseItemArray()
		{
		}

		public static bool operator ==(FRigUnit_HierarchySetPoseItemArray A, FRigUnit_HierarchySetPoseItemArray B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_HierarchySetPoseItemArray A, FRigUnit_HierarchySetPoseItemArray B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_HierarchySetPoseItemArray;

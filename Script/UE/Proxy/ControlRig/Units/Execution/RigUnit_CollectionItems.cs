...
{
	[PathName("/Script/ControlRig.RigUnit_CollectionItems")]
	public partial class FRigUnit_CollectionItems : FRigUnit_CollectionBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_CollectionItems");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_CollectionItems()
		{
		}

		public static bool operator ==(FRigUnit_CollectionItems A, FRigUnit_CollectionItems B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_CollectionItems A, FRigUnit_CollectionItems B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_CollectionItems;

...
{
	[PathName("/Script/ControlRig.RigUnit_HierarchyGetParentWeightsArray")]
	public partial class FRigUnit_HierarchyGetParentWeightsArray : FRigUnit_DynamicHierarchyBase, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_HierarchyGetParentWeightsArray");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_HierarchyGetParentWeightsArray()
		{
		}

		public static bool operator ==(FRigUnit_HierarchyGetParentWeightsArray A, FRigUnit_HierarchyGetParentWeightsArray B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_HierarchyGetParentWeightsArray A, FRigUnit_HierarchyGetParentWeightsArray B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_HierarchyGetParentWeightsArray;

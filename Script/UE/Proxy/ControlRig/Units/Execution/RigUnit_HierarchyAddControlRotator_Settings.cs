...
{
	[PathName("/Script/ControlRig.RigUnit_HierarchyAddControlRotator_Settings")]
	public partial class FRigUnit_HierarchyAddControlRotator_Settings : FRigUnit_HierarchyAddControl_Settings, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_HierarchyAddControlRotator_Settings");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_HierarchyAddControlRotator_Settings()
		{
		}

		public static bool operator ==(FRigUnit_HierarchyAddControlRotator_Settings A, FRigUnit_HierarchyAddControlRotator_Settings B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_HierarchyAddControlRotator_Settings A, FRigUnit_HierarchyAddControlRotator_Settings B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_HierarchyAddControlRotator_Settings;
		...
		public FRigUnit_HierarchyAddControlRotator_LimitSettings Limits
		{
			get
			{
				unsafe
				{
					...
					return *(FRigUnit_HierarchyAddControlRotator_LimitSettings*)__ReturnBuffer;
				}
			}

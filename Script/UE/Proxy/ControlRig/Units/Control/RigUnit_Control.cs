...
{
	[PathName("/Script/ControlRig.RigUnit_Control")]
	public partial class FRigUnit_Control : FRigUnit, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/ControlRig.RigUnit_Control");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FRigUnit_Control()
		{
		}

		public static bool operator ==(FRigUnit_Control A, FRigUnit_Control B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FRigUnit_Control A, FRigUnit_Control B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FRigUnit_Control;
		...
		public FTransform InitTransform
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __InitTransform, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __InitTransform, __InBuffer);
				}
			}
		}
		...
		private static uint __InitTransform = 0;

...
{
	[PathName("/Script/TargetDeviceServices.TargetDeviceClaimed")]
	public partial class FTargetDeviceClaimed : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/TargetDeviceServices.TargetDeviceClaimed");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FTargetDeviceClaimed() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FTargetDeviceClaimed() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FTargetDeviceClaimed A, FTargetDeviceClaimed B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FTargetDeviceClaimed A, FTargetDeviceClaimed B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FTargetDeviceClaimed;

...
{
	[PathName("/Script/MeshModelingTools.MeshEditingViewProperties")]
	public partial class UMeshEditingViewProperties : UInteractiveToolPropertySet, IStaticClass
	{
		...
		public EMeshEditingMaterialModes MaterialMode
		{
			get
			{
				unsafe
				{
					...
					return *(EMeshEditingMaterialModes*)__ReturnBuffer;
				}
			}
		...
		public TWeakObjectPtr<UMaterialInterface> CustomMaterial
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CustomMaterial, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CustomMaterial, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingTools.MeshEditingViewProperties");
		}
		...
		private static uint __CustomMaterial = 0;
	}
}
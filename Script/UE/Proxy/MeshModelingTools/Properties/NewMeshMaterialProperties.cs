...
{
	[PathName("/Script/MeshModelingTools.NewMeshMaterialProperties")]
	public partial class UNewMeshMaterialProperties : UInteractiveToolPropertySet, IStaticClass
	{
		...
		public bool bWorldSpaceUVScale
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bWorldSpaceUVScale, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bWorldSpaceUVScale, __InBuffer);
				}
			}
		}
		...
		public bool bShowExtendedOptions
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bShowExtendedOptions, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bShowExtendedOptions, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingTools.NewMeshMaterialProperties");
		}
		...
		private static uint __bWorldSpaceUVScale = 0;

		private static uint __bShowWireframe = 0;

		private static uint __bShowExtendedOptions = 0;
	}
}
...
{
	[PathName("/Script/MeshModelingTools.CombineMeshesTool")]
	public partial class UCombineMeshesTool : UMultiSelectionMeshEditingTool, IStaticClass, IInteractiveToolExclusiveToolAPI
	{
		public UCombineMeshesToolProperties BasicProperties
		{
			get
			{
				unsafe
				{
					...
					return *(UCombineMeshesToolProperties*)__ReturnBuffer;
				}
			}
		...
		public UOnAcceptHandleSourcesPropertiesBase HandleSourceProperties
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __HandleSourceProperties, __ReturnBuffer);

					return *(UOnAcceptHandleSourcesPropertiesBase*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __HandleSourceProperties, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingTools.CombineMeshesTool");
		}
		...
		private static uint __HandleSourceProperties = 0;

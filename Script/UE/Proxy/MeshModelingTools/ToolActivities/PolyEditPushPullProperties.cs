...
{
	[PathName("/Script/MeshModelingTools.PolyEditPushPullProperties")]
	public partial class UPolyEditPushPullProperties : UInteractiveToolPropertySet, IStaticClass
	{
		...
		public EPolyEditPushPullModeOptions DirectionMode
		{
			get
			{
				unsafe
				{
					...
					return *(EPolyEditPushPullModeOptions*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingTools.PolyEditPushPullProperties");
		}

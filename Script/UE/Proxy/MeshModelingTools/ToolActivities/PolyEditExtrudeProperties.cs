...
{
	[PathName("/Script/MeshModelingTools.PolyEditExtrudeProperties")]
	public partial class UPolyEditExtrudeProperties : UInteractiveToolPropertySet, IStaticClass
	{
		...
		public EPolyEditExtrudeModeOptions DirectionMode
		{
			get
			{
				unsafe
				{
					...
					return *(EPolyEditExtrudeModeOptions*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingTools.PolyEditExtrudeProperties");
		}

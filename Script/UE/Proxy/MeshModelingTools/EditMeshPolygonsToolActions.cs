...
{
	[PathName("/Script/MeshModelingTools.EditMeshPolygonsToolActions")]
	public partial class UEditMeshPolygonsToolActions : UEditMeshPolygonsToolActionPropertySet, IStaticClass
	{
		public new static UClass StaticClass()
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/MeshModelingTools.EditMeshPolygonsToolActions");
		}

		private static UClass StaticClassSingleton { get; set; }

		public virtual void SimplifyByGroups()
		{
			unsafe
			{
				FFunctionImplementation.FFunction_GenericCall8Implementation(GarbageCollectionHandle, __SimplifyByGroups);
			}
		}

		public virtual void Retriangulate()
		{
			unsafe
			{
				FFunctionImplementation.FFunction_GenericCall8Implementation(GarbageCollectionHandle, __Retriangulate);
			}
		}
		...
		public virtual void Merge()
		{
			unsafe
			{
				FFunctionImplementation.FFunction_GenericCall8Implementation(GarbageCollectionHandle, __Merge);
			}
		}
		...
		public virtual void InsertEdgeLoop()
		{
			unsafe
			{
				FFunctionImplementation.FFunction_GenericCall8Implementation(GarbageCollectionHandle, __InsertEdgeLoop);
			}
		}

		public virtual void InsertEdge()
		{
			unsafe
			{
				FFunctionImplementation.FFunction_GenericCall8Implementation(GarbageCollectionHandle, __InsertEdge);
			}
		}
		...
		public virtual void Decompose()
		{
			unsafe
			{
				FFunctionImplementation.FFunction_GenericCall8Implementation(GarbageCollectionHandle, __Decompose);
			}
		}
		...
		private static uint __SimplifyByGroups = 0;

		private static uint __Retriangulate = 0;
		...
		private static uint __Merge = 0;

		private static uint __Inset = 0;

		private static uint __InsertEdgeLoop = 0;

		private static uint __InsertEdge = 0;
		...
		private static uint __Decompose = 0;

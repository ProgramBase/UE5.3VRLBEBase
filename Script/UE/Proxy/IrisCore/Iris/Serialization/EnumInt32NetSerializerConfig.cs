...
{
	[PathName("/Script/IrisCore.EnumInt32NetSerializerConfig")]
	public partial class FEnumInt32NetSerializerConfig : FNetSerializerConfig, IStaticStruct, IGarbageCollectionHandle
	{
		public new static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/IrisCore.EnumInt32NetSerializerConfig");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FEnumInt32NetSerializerConfig()
		{
		}

		public static bool operator ==(FEnumInt32NetSerializerConfig A, FEnumInt32NetSerializerConfig B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FEnumInt32NetSerializerConfig A, FEnumInt32NetSerializerConfig B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FEnumInt32NetSerializerConfig;

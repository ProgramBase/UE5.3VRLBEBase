...
{
	[PathName("/Script/VariantManagerContentEditor.VariantManagerTestActor")]
	public partial class AVariantManagerTestActor : AActor, IStaticClass
	{
		public EVariantManagerTestEnum EnumWithNoDefault
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __EnumWithNoDefault, __ReturnBuffer);

					return *(EVariantManagerTestEnum*)__ReturnBuffer;
				}
			}
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __EnumWithNoDefault, __InBuffer);
				}
			}
		}
		...
		public EVariantManagerTestEnum EnumWithSecondDefault
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __EnumWithSecondDefault, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(byte*)__InBuffer = (byte)value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __EnumWithSecondDefault, __InBuffer);
				}
			}
		}
		...
		public FRotator CapturedRotatorProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedRotatorProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedRotatorProperty, __InBuffer);
				}
			}
		}
		...
		public FColor CapturedColorProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedColorProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedColorProperty, __InBuffer);
				}
			}
		}
		...
		public FLinearColor CapturedLinearColorProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedLinearColorProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedLinearColorProperty, __InBuffer);
				}
			}
		}
		...
		public FQuat CapturedQuatProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedQuatProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedQuatProperty, __InBuffer);
				}
			}
		}
		...
		public FVector4 CapturedVector4Property
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedVector4Property, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedVector4Property, __InBuffer);
				}
			}
		}
		...
		public FVector2D CapturedVector2DProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedVector2DProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedVector2DProperty, __InBuffer);
				}
			}
		}
		...
		public FIntPoint CapturedIntPointProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedIntPointProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedIntPointProperty, __InBuffer);
				}
			}
		}
		...
		public TArray<UObject> CapturedUObjectArrayProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedUObjectArrayProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedUObjectArrayProperty, __InBuffer);
				}
			}
		}
		...
		public TArray<FVector> CapturedVectorArrayProperty
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedVectorArrayProperty, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __CapturedVectorArrayProperty, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/VariantManagerContentEditor.VariantManagerTestActor");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __EnumWithNoDefault = 0;

		private static uint __EnumWithSecondDefault = 0;
		...
		private static uint __CapturedRotatorProperty = 0;

		private static uint __CapturedColorProperty = 0;

		private static uint __CapturedLinearColorProperty = 0;

		private static uint __CapturedVectorProperty = 0;

		private static uint __CapturedQuatProperty = 0;

		private static uint __CapturedVector4Property = 0;

		private static uint __CapturedVector2DProperty = 0;

		private static uint __CapturedIntPointProperty = 0;

		private static uint __CapturedUObjectArrayProperty = 0;

		private static uint __CapturedVectorArrayProperty = 0;
	}
}
...
{
	[PathName("/Script/NavigationSystem.NavLinkComponent")]
	public partial class UNavLinkComponent : UPrimitiveComponent, IStaticClass, INavLinkHostInterface
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/NavigationSystem.NavLinkComponent");
		}

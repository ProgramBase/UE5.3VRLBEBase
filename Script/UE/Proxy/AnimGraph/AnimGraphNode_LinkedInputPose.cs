...
{
	[PathName("/Script/AnimGraph.AnimGraphNode_LinkedInputPose")]
	public partial class UAnimGraphNode_LinkedInputPose : UAnimGraphNode_Base, IStaticClass, IClassVariableCreator
	{
		public FAnimNode_LinkedInputPose Node
		{
			get
			{
				unsafe
				{
					...
					return *(FAnimNode_LinkedInputPose*)__ReturnBuffer;
				}
			}
		...
		public TArray<FAnimBlueprintFunctionPinInfo> Inputs
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<FAnimBlueprintFunctionPinInfo>*)__ReturnBuffer;
				}
			}
		...
		public int InputPoseIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __InputPoseIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __InputPoseIndex, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AnimGraph.AnimGraphNode_LinkedInputPose");
		}
		...
		private static uint __InputPoseIndex = 0;

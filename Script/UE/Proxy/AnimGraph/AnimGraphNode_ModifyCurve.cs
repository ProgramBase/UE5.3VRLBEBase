...
{
	[PathName("/Script/AnimGraph.AnimGraphNode_ModifyCurve")]
	public partial class UAnimGraphNode_ModifyCurve : UAnimGraphNode_Base, IStaticClass
	{
		public FAnimNode_ModifyCurve Node
		{
			get
			{
				unsafe
				{
					...
					return *(FAnimNode_ModifyCurve*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AnimGraph.AnimGraphNode_ModifyCurve");
		}

...
{
	[PathName("/Script/AnimGraph.AnimGraphNode_CCDIK")]
	public partial class UAnimGraphNode_CCDIK : UAnimGraphNode_SkeletalControlBase, IStaticClass
	{
		public FAnimNode_CCDIK Node
		{
			get
			{
				unsafe
				{
					...
					return *(FAnimNode_CCDIK*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/AnimGraph.AnimGraphNode_CCDIK");
		}

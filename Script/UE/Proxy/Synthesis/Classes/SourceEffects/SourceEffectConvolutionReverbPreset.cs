...
{
	[PathName("/Script/Synthesis.SourceEffectConvolutionReverbPreset")]
	public partial class USourceEffectConvolutionReverbPreset : USoundEffectSourcePreset, IStaticClass
	{
		...
		public FSourceEffectConvolutionReverbSettings Settings
		{
			get
			{
				unsafe
				{
					...
					return *(FSourceEffectConvolutionReverbSettings*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Synthesis.SourceEffectConvolutionReverbPreset");
		}

		private static UClass StaticClassSingleton { get; set; }

		public virtual void SetSettings(FSourceEffectConvolutionReverbSettings InSettings)
		{
			unsafe
			{
				var __InBuffer = stackalloc byte[8];

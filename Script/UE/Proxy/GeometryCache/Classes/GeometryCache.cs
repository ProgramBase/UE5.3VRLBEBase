...
{
	[PathName("/Script/GeometryCache.GeometryCache")]
	public partial class UGeometryCache : UObject, IStaticClass, IInterface_AssetUserData
	{
		...
		public TArray<FName> MaterialSlotNames
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MaterialSlotNames, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MaterialSlotNames, __InBuffer);
				}
			}
		}
		...
		public TArray<UGeometryCacheTrack> Tracks
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<UGeometryCacheTrack>*)__ReturnBuffer;
				}
			}
		...
		public ulong Hash
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Hash, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(ulong*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Hash, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/GeometryCache.GeometryCache");
		}
		...
		private static uint __MaterialSlotNames = 0;

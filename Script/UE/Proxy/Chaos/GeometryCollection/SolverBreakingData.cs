...
{
	[PathName("/Script/Chaos.SolverBreakingData")]
	public partial class FSolverBreakingData : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Chaos.SolverBreakingData");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FSolverBreakingData() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FSolverBreakingData() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FSolverBreakingData A, FSolverBreakingData B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FSolverBreakingData A, FSolverBreakingData B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FSolverBreakingData;

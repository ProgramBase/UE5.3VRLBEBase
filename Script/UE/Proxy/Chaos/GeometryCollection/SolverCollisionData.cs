...
{
	[PathName("/Script/Chaos.SolverCollisionData")]
	public partial class FSolverCollisionData : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/Chaos.SolverCollisionData");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FSolverCollisionData() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FSolverCollisionData() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FSolverCollisionData A, FSolverCollisionData B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FSolverCollisionData A, FSolverCollisionData B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FSolverCollisionData;
		...
		public FVector AngularVelocity1
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __AngularVelocity1, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __AngularVelocity1, __InBuffer);
				}
			}
		}
		...
		public FVector AngularVelocity2
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __AngularVelocity2, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __AngularVelocity2, __InBuffer);
				}
			}
		}
		...
		public int LevelsetIndex
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __LevelsetIndex, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __LevelsetIndex, __InBuffer);
				}
			}
		}
		...
		public int LevelsetIndexMesh
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetStructPropertyImplementation(GarbageCollectionHandle, __LevelsetIndexMesh, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetStructPropertyImplementation(GarbageCollectionHandle, __LevelsetIndexMesh, __InBuffer);
				}
			}
		}
		...
		private static uint __AngularVelocity1 = 0;

		private static uint __AngularVelocity2 = 0;
		...
		private static uint __LevelsetIndex = 0;

		private static uint __ParticleIndexMesh = 0;

		private static uint __LevelsetIndexMesh = 0;

...
{
	[PathName("/Script/DataflowEngine.Dataflow")]
	public partial class UDataflow : UEdGraph, IStaticClass
	{
		public bool bActive
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/DataflowEngine.Dataflow");
		}

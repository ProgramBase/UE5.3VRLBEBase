...
{
	[PathName("/Script/TranslationEditor.TranslationUnit")]
	public partial class UTranslationUnit : UObject, IStaticClass
	{
		...
		public TArray<FTranslationContextInfo> Contexts
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<FTranslationContextInfo>*)__ReturnBuffer;
				}
			}
		...
		public bool HasBeenReviewed
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __HasBeenReviewed, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __HasBeenReviewed, __InBuffer);
				}
			}
		}

		public FString TranslationBeforeImport
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __TranslationBeforeImport, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __TranslationBeforeImport, __InBuffer);
				}
			}
		}

		public FString LocresPath
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LocresPath, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LocresPath, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/TranslationEditor.TranslationUnit");
		}
		...
		private static uint __HasBeenReviewed = 0;

		private static uint __TranslationBeforeImport = 0;

		private static uint __LocresPath = 0;
	}
}
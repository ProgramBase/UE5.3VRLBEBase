...
{
	[PathName("/Script/Niagara.NiagaraDataInterfaceGrid2D")]
	public partial class UNiagaraDataInterfaceGrid2D : UNiagaraDataInterfaceRWBase, IStaticClass
	{
		...
		public bool SetGridFromMaxAxis
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SetGridFromMaxAxis, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SetGridFromMaxAxis, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Niagara.NiagaraDataInterfaceGrid2D");
		}
		...
		private static uint __SetGridFromMaxAxis = 0;

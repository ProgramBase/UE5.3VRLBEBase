...
{
	[PathName("/Script/Niagara.NiagaraDataInterfaceIntRenderTarget2D")]
	public partial class UNiagaraDataInterfaceIntRenderTarget2D : UNiagaraDataInterfaceRWBase, IStaticClass
	{
		...
		public FVector2D PreviewDisplayRange
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __PreviewDisplayRange, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __PreviewDisplayRange, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Niagara.NiagaraDataInterfaceIntRenderTarget2D");
		}
		...
		private static uint __PreviewDisplayRange = 0;

...
{
	[PathName("/Script/Niagara.NiagaraEmitter")]
	public partial class UNiagaraEmitter : UObject, IStaticClass
	{
		...
		public TArray<FVersionedNiagaraEmitterData> VersionData
		{
			get
			{
				unsafe
				{
					...
					return *(TArray<FVersionedNiagaraEmitterData>*)__ReturnBuffer;
				}
			}
		...
		public FString UniqueEmitterName
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __UniqueEmitterName, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(nint*)__InBuffer = value?.GarbageCollectionHandle ?? nint.Zero;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __UniqueEmitterName, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/Niagara.NiagaraEmitter");
		}
		...
		private static uint __UniqueEmitterName = 0;

...
{
	[PathName("/Script/UnrealEd.CubeBuilder")]
	public partial class UCubeBuilder : UEditorBrushBuilder, IStaticClass
	{
		public float X
		{
			get
		...
		public float WallThickness
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __WallThickness, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __WallThickness, __InBuffer);
				}
			}
		}
		...
		public bool Tessellated
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Tessellated, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Tessellated, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.CubeBuilder");
		}
		...
		private static uint __WallThickness = 0;

		private static uint __GroupName = 0;

		private static uint __Hollow = 0;

		private static uint __Tessellated = 0;
	}
}
...
{
	[PathName("/Script/UnrealEd.VolumetricBuilder")]
	public partial class UVolumetricBuilder : UEditorBrushBuilder, IStaticClass
	{
		public float Z
		{
			get
		...
		public int NumSheets
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __NumSheets, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __NumSheets, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.VolumetricBuilder");
		}
		...
		private static uint __NumSheets = 0;

...
{
	[PathName("/Script/UnrealEd.SheetBuilder")]
	public partial class USheetBuilder : UEditorBrushBuilder, IStaticClass
	{
		public int X
		{
			get
		...
		public int XSegments
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __XSegments, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __XSegments, __InBuffer);
				}
			}
		}
		...
		public int YSegments
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __YSegments, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __YSegments, __InBuffer);
				}
			}
		}
		...
		public ESheetAxis Axis
		{
			get
			{
				unsafe
				{
					...
					return *(ESheetAxis*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.SheetBuilder");
		}
		...
		private static uint __XSegments = 0;

		private static uint __YSegments = 0;

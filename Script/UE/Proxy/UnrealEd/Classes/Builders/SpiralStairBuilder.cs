...
{
	[PathName("/Script/UnrealEd.SpiralStairBuilder")]
	public partial class USpiralStairBuilder : UEditorBrushBuilder, IStaticClass
	{
		...
		public int StepThickness
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __StepThickness, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __StepThickness, __InBuffer);
				}
			}
		}
		...
		public int NumStepsPer360
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __NumStepsPer360, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __NumStepsPer360, __InBuffer);
				}
			}
		}
		...
		public bool SlopedCeiling
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SlopedCeiling, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SlopedCeiling, __InBuffer);
				}
			}
		}
		...
		public bool SlopedFloor
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SlopedFloor, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SlopedFloor, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.SpiralStairBuilder");
		}
		...
		private static uint __StepThickness = 0;

		private static uint __NumStepsPer360 = 0;

		private static uint __NumSteps = 0;

		private static uint __GroupName = 0;

		private static uint __SlopedCeiling = 0;

		private static uint __SlopedFloor = 0;

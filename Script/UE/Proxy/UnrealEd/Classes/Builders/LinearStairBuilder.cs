...
{
	[PathName("/Script/UnrealEd.LinearStairBuilder")]
	public partial class ULinearStairBuilder : UEditorBrushBuilder, IStaticClass
	{
		public int StepLength
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __StepLength, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __StepLength, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.LinearStairBuilder");
		}

		private static UClass StaticClassSingleton { get; set; }

		private static uint __StepLength = 0;

...
{
	[PathName("/Script/UnrealEd.TetrahedronBuilder")]
	public partial class UTetrahedronBuilder : UEditorBrushBuilder, IStaticClass
	{
		public float Radius
		{
			get
		...
		public int SphereExtrapolation
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __SphereExtrapolation, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(int*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __SphereExtrapolation, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.TetrahedronBuilder");
		}
		...
		private static uint __SphereExtrapolation = 0;

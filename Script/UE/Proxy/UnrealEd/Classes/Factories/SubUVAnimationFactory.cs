...
{
	[PathName("/Script/UnrealEd.SubUVAnimationFactory")]
	public partial class USubUVAnimationFactory : UFactory, IStaticClass
	{
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.SubUVAnimationFactory");
		}

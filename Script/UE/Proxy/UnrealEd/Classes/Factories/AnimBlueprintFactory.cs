...
{
	[PathName("/Script/UnrealEd.AnimBlueprintFactory")]
	public partial class UAnimBlueprintFactory : UFactory, IStaticClass
	{
		...
		public TSubclassOf<UAnimInstance> ParentClass
		{
			get
			{
				unsafe
		...
		public bool bTemplate
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bTemplate, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bTemplate, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.AnimBlueprintFactory");
		}
		...
		private static uint __bTemplate = 0;
	}
}
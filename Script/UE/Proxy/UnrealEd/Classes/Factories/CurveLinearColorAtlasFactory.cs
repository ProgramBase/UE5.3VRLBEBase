...
{
	[PathName("/Script/UnrealEd.CurveLinearColorAtlasFactory")]
	public partial class UCurveLinearColorAtlasFactory : UFactory, IStaticClass
	{
		public int Width
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.CurveLinearColorAtlasFactory");
		}

...
{
	[PathName("/Script/UnrealEd.TextureRenderTargetFactoryNew")]
	public partial class UTextureRenderTargetFactoryNew : UFactory, IStaticClass
	{
		public int Width
		{
			get
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.TextureRenderTargetFactoryNew");
		}

...
{
	[PathName("/Script/UnrealEd.FbxExportOption")]
	public partial class UFbxExportOption : UObject, IStaticClass
	{
		...
		public bool LevelOfDetail
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __LevelOfDetail, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __LevelOfDetail, __InBuffer);
				}
			}
		}
		...
		public bool Collision
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __Collision, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __Collision, __InBuffer);
				}
			}
		}
		...
		public bool bExportSourceMesh
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __bExportSourceMesh, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __bExportSourceMesh, __InBuffer);
				}
			}
		}
		...
		public bool MapSkeletalMotionToRoot
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __MapSkeletalMotionToRoot, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(bool*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __MapSkeletalMotionToRoot, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UnrealEd.FbxExportOption");
		}
		...
		private static uint __LevelOfDetail = 0;

		private static uint __Collision = 0;

		private static uint __bExportSourceMesh = 0;

		private static uint __bExportMorphTargets = 0;

		private static uint __bExportPreviewMesh = 0;

		private static uint __MapSkeletalMotionToRoot = 0;

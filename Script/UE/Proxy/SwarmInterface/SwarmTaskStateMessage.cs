...
{
	[PathName("/Script/SwarmInterface.SwarmTaskStateMessage")]
	public partial class FSwarmTaskStateMessage : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/SwarmInterface.SwarmTaskStateMessage");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FSwarmTaskStateMessage() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FSwarmTaskStateMessage() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FSwarmTaskStateMessage A, FSwarmTaskStateMessage B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FSwarmTaskStateMessage A, FSwarmTaskStateMessage B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FSwarmTaskStateMessage;

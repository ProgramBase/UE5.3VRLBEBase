...
{
	[PathName("/Script/UVEditorTools.BasicLineSetComponentBase")]
	public partial class UBasicLineSetComponentBase : UMeshComponent, IStaticClass
	{
		...
		public float DepthBias
		{
			get
			{
				unsafe
				{
					...
					FPropertyImplementation.FProperty_GetObjectPropertyImplementation(GarbageCollectionHandle, __DepthBias, __ReturnBuffer);
			...
			set
			{
				unsafe
				{
					...
					*(float*)__InBuffer = value;
					...
					FPropertyImplementation.FProperty_SetObjectPropertyImplementation(GarbageCollectionHandle, __DepthBias, __InBuffer);
				}
			}
		}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/UVEditorTools.BasicLineSetComponentBase");
		}
		...
		private static uint __DepthBias = 0;
	}
}
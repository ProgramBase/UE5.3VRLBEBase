...
{
	[PathName("/Script/CoreUObject.IntVector4")]
	public partial class FIntVector4 : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/CoreUObject.IntVector4");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FIntVector4() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FIntVector4() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FIntVector4 A, FIntVector4 B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FIntVector4 A, FIntVector4 B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FIntVector4;

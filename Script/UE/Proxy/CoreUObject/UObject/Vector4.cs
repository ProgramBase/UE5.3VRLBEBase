...
{
	[PathName("/Script/CoreUObject.Vector4")]
	public partial class FVector4 : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/CoreUObject.Vector4");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FVector4() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FVector4() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FVector4 A, FVector4 B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FVector4 A, FVector4 B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FVector4;

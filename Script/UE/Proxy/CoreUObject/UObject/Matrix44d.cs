...
{
	[PathName("/Script/CoreUObject.Matrix44d")]
	public partial class FMatrix44d : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/CoreUObject.Matrix44d");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FMatrix44d() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FMatrix44d() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FMatrix44d A, FMatrix44d B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FMatrix44d A, FMatrix44d B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FMatrix44d;
		...
		public FPlane4d XPlane
		{
			get
			{
				unsafe
				{
					...
					return *(FPlane4d*)__ReturnBuffer;
				}
			}

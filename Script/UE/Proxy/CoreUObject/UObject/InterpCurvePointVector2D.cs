...
{
	[PathName("/Script/CoreUObject.InterpCurvePointVector2D")]
	public partial class FInterpCurvePointVector2D : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/CoreUObject.InterpCurvePointVector2D");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FInterpCurvePointVector2D() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FInterpCurvePointVector2D() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FInterpCurvePointVector2D A, FInterpCurvePointVector2D B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FInterpCurvePointVector2D A, FInterpCurvePointVector2D B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FInterpCurvePointVector2D;

...
{
	[PathName("/Script/CoreUObject.InterpCurvePointTwoVectors")]
	public partial class FInterpCurvePointTwoVectors : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/CoreUObject.InterpCurvePointTwoVectors");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FInterpCurvePointTwoVectors() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FInterpCurvePointTwoVectors() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FInterpCurvePointTwoVectors A, FInterpCurvePointTwoVectors B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FInterpCurvePointTwoVectors A, FInterpCurvePointTwoVectors B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FInterpCurvePointTwoVectors;
		...
		public FTwoVectors OutVal
		{
			get
			{
				unsafe
				{
					...
					return *(FTwoVectors*)__ReturnBuffer;
				}
			}

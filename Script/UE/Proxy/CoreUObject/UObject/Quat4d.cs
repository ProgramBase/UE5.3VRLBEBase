...
{
	[PathName("/Script/CoreUObject.Quat4d")]
	public partial class FQuat4d : IStaticStruct, IGarbageCollectionHandle
	{
		public static UScriptStruct StaticStruct()
		{
			return StaticStructSingleton ??= UStructImplementation.UStruct_StaticStructImplementation("/Script/CoreUObject.Quat4d");
		}

		private static UScriptStruct StaticStructSingleton { get; set; }

		public FQuat4d() => UStructImplementation.UStruct_RegisterImplementation(this, Utils.GetPathName(GetType()));

		~FQuat4d() => UStructImplementation.UStruct_UnRegisterImplementation(GarbageCollectionHandle);

		public static bool operator ==(FQuat4d A, FQuat4d B) => Utils.EqualsTo(A, B, UStructImplementation.UStruct_IdenticalImplementation);

		public static bool operator !=(FQuat4d A, FQuat4d B) => !(A == B);

		public override bool Equals(object Other) => this == Other as FQuat4d;

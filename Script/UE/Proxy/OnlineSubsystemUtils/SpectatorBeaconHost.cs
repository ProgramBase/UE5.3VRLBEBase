...
{
	[PathName("/Script/OnlineSubsystemUtils.SpectatorBeaconHost")]
	public partial class ASpectatorBeaconHost : AOnlineBeaconHostObject, IStaticClass
	{
		public USpectatorBeaconState State
		{
			get
			{
				unsafe
				{
					...
					return *(USpectatorBeaconState*)__ReturnBuffer;
				}
			}
		...
		{
			return StaticClassSingleton ??= UObjectImplementation.UObject_StaticClassImplementation("/Script/OnlineSubsystemUtils.SpectatorBeaconHost");
		}
